...
bool Ana003_Lambda_corr_2D_get_corr_Q(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
...
/*
  ...
  TH1F *SysErrSlope_Q_hist[3];

  for( unsigned int Q_bin = 0; Q_bin < 2; Q_bin++ )
  {
    //SysErrSlope_Q_hist[Q_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_Q_hist_%i", Q_bin));
    SysErrSlope_Q_hist[Q_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_delta_eta_delta_phi_hist_%i", Q_bin));
  }
*/
...
/*
  ...
  if(cut_type == 0 )
  {
    //SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Q.root", year), "read");
    ...
    //SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Q.root", year), "read");
  ...
  {
    if( cut_type == 1 ) SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Q_work.root", year), "recreate");
    if( cut_type == 2 ) SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Q_work.root", year), "recreate");
  }

  //tight cuts
  TF1 *fitL0_L0bar_tight_topo_cuts_Q[3];
  TF1 *fitL0_L0_tight_topo_cuts_Q[3];
  TF1 *fitL0bar_L0bar_tight_topo_cuts_Q[3];

  TF1 *fitL0_L0bar_tight_pT_cuts_Q[3];
  TF1 *fitL0_L0_tight_pT_cuts_Q[3];
  TF1 *fitL0bar_L0bar_tight_pT_cuts_Q[3];
  ...
  for( unsigned int Q_bin = 0; Q_bin < 2; Q_bin++)
  {
    if(cut_type == 0 )
    {
      ...
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Q_%i", Q_bin));
      fitL0_L0_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Q_%i", Q_bin));
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Q_%i", Q_bin));

      fitL0_L0bar_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Q_%i", Q_bin));
      fitL0_L0_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Q_%i", Q_bin));
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Q_%i", Q_bin));

      fitL0_L0bar_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_Delta_phi_%i", Q_bin));
      fitL0_L0_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Delta_y_Delta_phi_%i", Q_bin));
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_Delta_phi_%i", Q_bin));

      fitL0_L0bar_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_Delta_phi_%i", Q_bin));
      fitL0_L0_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Delta_y_Delta_phi_%i", Q_bin));
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_Delta_phi_%i", Q_bin));

    }
    else
    {
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin] = new TF1(Form("fitL0_L0bar_tight_topo_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_topo_cuts_Q[Q_bin] = new TF1(Form("fitL0_L0_tight_topo_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_topo_cuts_Q[Q_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin] = new TF1(Form("fitL0bar_L0bar_tight_topo_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_pT_cuts_Q[Q_bin] = new TF1(Form("fitL0_L0bar_tight_pT_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_pT_cuts_Q[Q_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_pT_cuts_Q[Q_bin] = new TF1(Form("fitL0_L0_tight_pT_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_pT_cuts_Q[Q_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin] = new TF1(Form("fitL0bar_L0bar_tight_pT_cuts_Q_%i", Q_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin]->SetParameters(100, 0.5);
    }
...
*/
  ...
  TFile *out_file = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/Polarization/%i/Polarization_Q.root", year), "recreate");
  ...
  if(cut_type == 0)
  {
    if(year == 2012)
    {
      ...
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/20240729_tests_5sigma_signal/ProdPlane_Lambda_ana_cuts_2_sigma_signal.root", year), "read"); //analysis cuts
      ...
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/tests_GPC/ProdPlane_Lambda_ana_cuts_ME_Delta_phi_0.1.root", year), "read"); //analysis cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/tests_GPC/ProdPlane_Lambda_ana_cuts_ME_Delta_phi_0.1_old_auto_corr_old_prod.root", year), "read"); //analysis cuts
  ...
  //data histograms
  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_hist");

  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_LS_hist");

  //--------------------------------------------------------

  TH2F *L0_L0_cos_theta_star_vs_Q_US_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_hist");

  TH2F *L0_L0_cos_theta_star_vs_Q_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_LS_hist");

  //--------------------------------------------------------

  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_hist");

  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_LS_hist");

  //--------------------------------------------------------

  //mixed event
  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_ME_hist");
  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist");

  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_ME_alt_hist");
  TH2F *L0_L0bar_cos_theta_star_vs_Q_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_Q_US_LS_ME_alt_hist");

  //--------------------------------------------------------

  TH2F *L0_L0_cos_theta_star_vs_Q_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_ME_hist");
  TH2F *L0_L0_cos_theta_star_vs_Q_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_LS_ME_hist");

  TH2F *L0_L0_cos_theta_star_vs_Q_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_ME_alt_hist");
  TH2F *L0_L0_cos_theta_star_vs_Q_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_Q_US_LS_ME_alt_hist");

  //--------------------------------------------------------

  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_ME_hist");
  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist");

  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_ME_alt_hist");
  TH2F *L0bar_L0bar_cos_theta_star_vs_Q_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_Q_US_LS_ME_alt_hist");
  ...
  TGraphErrors *PolarizationGraph_Q[3];
  TGraphErrors *PolarizationGraph_Q_sys_err[3];


  TGraphErrors *PolarizationGraph_Q_epsilon[3];
  TGraphErrors *PolarizationGraph_Q_epsilon_sys_err[3];


  TCanvas *PolarizationGraph_Q_can = new TCanvas("PolarizationGraph_Q_can", "PolarizationGraph_Q_can", 3000, 1200);
  PolarizationGraph_Q_can->Divide(3,1);
  ...
  TCanvas *PolarizationGraph_Q_epsilon_can = new TCanvas("PolarizationGraph_Q_epsilon_can", "PolarizationGraph_Q_epsilon_can", 3000, 1200);
  PolarizationGraph_Q_epsilon_can->Divide(3,1);
  ...
  TLine *ZeroLine_Q = new TLine(0.75,0.01,0.75,3.99);
  ZeroLine_Q->SetLineStyle(9);
  ZeroLine_Q->SetLineColor(1);
  //ZeroLine_eta->Draw("same");
  ...
  TPaveText *bin_text[3];

  out_file->cd();

  for( unsigned int Q_bin = 1; Q_bin < 4; Q_bin++)
  {
    //create polarization graphs, defined earlier

    PolarizationGraph_Q[Q_bin-1] = new TGraphErrors(3);
    PolarizationGraph_Q_sys_err[Q_bin-1] = new TGraphErrors(3);


    PolarizationGraph_Q_epsilon[Q_bin-1] = new TGraphErrors(3);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1] = new TGraphErrors(3);
    ...
    TCanvas *L0_L0bar_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), Form("L0_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), 1200, 1000);

    L0_L0bar_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0_L0bar_cosThetaProdPlane_eta_US_hist = L0_L0bar_cos_theta_star_vs_Q_US_hist->ProjectionX( Form("proj_US_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_ME_hist = L0_L0bar_cos_theta_star_vs_Q_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_LS_hist = L0_L0bar_cos_theta_star_vs_Q_US_LS_hist->ProjectionX( Form("proj_LS_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_ME_LS_hist = L0_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Q_bin), bin_min, bin_max);
    ...
    L0_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0bar_cosThetaProdPlane_eta_no_corr_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0_L0bar_cosThetaProdPlane_eta_can = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_can_%i", Q_bin), Form("L0_L0bar_cosThetaProdPlane_eta_can_%i", Q_bin), 1200, 1000);
    ...
    L0_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0bar_cosThetaProdPlane_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------

    TCanvas *L0_L0bar_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_can_2_%i", Q_bin), Form("L0_L0bar_cosThetaProdPlane_eta_can_2_%i", Q_bin), 1200, 1000);
    ...
    L0_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0bar_cosThetaProdPlane_Q_%i", Q_bin-1));
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
...
/*
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->Write();
    }
*/
    ...
    //slope
    //float SysErrSlope_L0_L0bar = SysErrSlope_Q_hist[Q_bin-1]->GetBinContent(1);
...
/*
    ...
    if(cut_type == 0)
    {
      float P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_topo_cuts_err = fitL0_L0bar_tight_topo_cuts_Q[Q_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
      ...
      float P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_pT_cuts_err = fitL0_L0bar_tight_pT_cuts_Q[Q_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
...
*/
    ...
    float SysErrTot_L0_L0bar = sqrt( sysErr_alpha_L0_L0bar*sysErr_alpha_L0_L0bar + SysErrBackground_L0_L0bar*SysErrBackground_L0_L0bar );
    ...
    L0_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0bar_cosThetaProdPlane_eta_subtract_Q_%i.png", Q_bin));

    //-----------------------


    PolarizationGraph_Q[Q_bin-1]->SetPoint(1, P_L0_L0bar_2, 1);
    PolarizationGraph_Q[Q_bin-1]->SetPointError(1, fabs(P_L0_L0bar_err_2), 0);

    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPoint(1, P_L0_L0bar_2, 1);
    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPointError(1, fabs(SysErrTot_L0_L0bar*P_L0_L0bar_2), 0.045);

    //------------------------------

    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPoint(1, fitL0_L0bar_US_ThetaStar_2_epsilon->GetParameter(1), 1);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPointError(1, fabs(fitL0_L0bar_US_ThetaStar_2_epsilon->GetParError(1)), 0);

    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPoint(1, fitL0_L0bar_US_ThetaStar_2_epsilon->GetParameter(1), 1);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPointError(1, fabs(SysErrTot_L0_L0bar*fitL0_L0bar_US_ThetaStar_2_epsilon->GetParameter(1)), 0.045);

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    TCanvas *L0_L0_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), Form("L0_L0_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), 1200, 1000);

    L0_L0_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0_L0_cosThetaProdPlane_eta_US_hist = L0_L0_cos_theta_star_vs_Q_US_hist->ProjectionX( Form("proj_US_%i", Q_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_hist = L0_L0_cos_theta_star_vs_Q_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_LS_hist = L0_L0_cos_theta_star_vs_Q_US_LS_hist->ProjectionX( Form("proj_LS_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_LS_hist = L0_L0_cos_theta_star_vs_Q_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Q_bin), bin_min, bin_max);
    ...
    L0_L0_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0_cosThetaProdPlane_eta_no_corr_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0_L0_cosThetaProdPlane_eta_can = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_can_%i", Q_bin), Form("L0_L0_cosThetaProdPlane_eta_can_%i", Q_bin), 1200, 1000);
    ...
    L0_L0_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0_cosThetaProdPlane_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------

    TCanvas *L0_L0_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_can_2_%i", Q_bin), Form("L0_L0_cosThetaProdPlane_eta_can_2_%i", Q_bin), 1200, 1000);

    L0_L0_cosThetaProdPlane_eta_can_2->cd();

    L0_L0_cosThetaProdPlane_eta_US_hist->Add(L0_L0_cosThetaProdPlane_eta_LS_hist, -1);
    L0_L0_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0_cosThetaProdPlane_Q_%i", Q_bin-1));
    L0_L0_cosThetaProdPlane_eta_US_hist->Draw("p e");
...
/*
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->Write();
    }
*/
    ...
    L0_L0_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0_L0_cosThetaProdPlane_eta_subtract_Q_%i.png", Q_bin));
    ...
    //slope
    //float SysErrSlope_L0_L0 = SysErrSlope_Q_hist[Q_bin-1]->GetBinContent(2);
...
/*
    ...
    if(cut_type == 0)
    {
      float P_L0_L0_tight_topo_cuts = fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_topo_cuts_err = fitL0_L0_tight_topo_cuts_Q[Q_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
      ...
      float P_L0_L0_tight_pT_cuts = fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_pT_cuts_err = fitL0_L0_tight_pT_cuts_Q[Q_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
...
*/
    ...
    float SysErrTot_L0_L0 = sqrt( sysErr_alpha_L0_L0*sysErr_alpha_L0_L0 + SysErrBackground_L0_L0*SysErrBackground_L0_L0 );


    PolarizationGraph_Q[Q_bin-1]->SetPoint(2, P_L0_L0_2, 2);
    PolarizationGraph_Q[Q_bin-1]->SetPointError(2, fabs(P_L0_L0_err_2), 0);

    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPoint(2, P_L0_L0_2, 2);
    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPointError(2, fabs(SysErrTot_L0_L0*P_L0_L0_2), 0.045);

    //------------------------------

    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPoint(2, fitL0_L0_US_ThetaStar_2_epsilon->GetParameter(1), 2);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPointError(2, fabs(fitL0_L0_US_ThetaStar_2_epsilon->GetParError(1)), 0);

    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPoint(2, fitL0_L0_US_ThetaStar_2_epsilon->GetParameter(1), 2);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPointError(2, fabs(SysErrTot_L0_L0*fitL0_L0_US_ThetaStar_2_epsilon->GetParameter(1)), 0.045);

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Q_bin), 1200, 1000);

    L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_US_hist = L0bar_L0bar_cos_theta_star_vs_Q_US_hist->ProjectionX( Form("proj_US_%i", Q_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_hist = L0bar_L0bar_cos_theta_star_vs_Q_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_LS_hist = L0bar_L0bar_cos_theta_star_vs_Q_US_LS_hist->ProjectionX( Form("proj_LS_%i", Q_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_LS_hist = L0bar_L0bar_cos_theta_star_vs_Q_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Q_bin), bin_min, bin_max);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0bar_L0bar_cosThetaProdPlane_eta_no_corr_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_can = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_can_%i", Q_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_can_%i", Q_bin), 1200, 1000);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0bar_L0bar_cosThetaProdPlane_Q_%i.png", Q_bin));

    //----------------------------------------------------------------------

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_can_2_%i", Q_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_can_2_%i", Q_bin), 1200, 1000);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0bar_L0bar_cosThetaProdPlane_Q_%i", Q_bin-1));
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
...
/*
    ...
    if(cut_type == 1)
    {
      ...
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->Write();
    }
*/
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_Q/L0bar_L0bar_cosThetaProdPlane_eta_subtract_Q_%i.png", Q_bin));
    ...
    //slope
    //float SysErrSlope_L0bar_L0bar = SysErrSlope_Q_hist[Q_bin-1]->GetBinContent(3);
...
/*
    if(cut_type == 0)
    {
      float P_L0bar_L0bar_tight_topo_cuts = fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_topo_cuts_err = fitL0bar_L0bar_tight_topo_cuts_Q[Q_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
      ...
      float P_L0bar_L0bar_tight_pT_cuts = fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_pT_cuts_err = fitL0bar_L0bar_tight_pT_cuts_Q[Q_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
...
*/
    ...
    float SysErrTot_L0bar_L0bar = sqrt( sysErr_alpha_L0bar_L0bar*sysErr_alpha_L0bar_L0bar + SysErrBackground_L0bar_L0bar*SysErrBackground_L0bar_L0bar );


    PolarizationGraph_Q[Q_bin-1]->SetPoint(3, P_L0bar_L0bar_2, 3);
    PolarizationGraph_Q[Q_bin-1]->SetPointError(3, fabs(P_L0bar_L0bar_err_2), 0);

    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPoint(3, P_L0bar_L0bar_2, 3);
    PolarizationGraph_Q_sys_err[Q_bin-1]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar*P_L0bar_L0bar_2), 0.045);

    //------------------------------

    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPoint(3, fitL0bar_L0bar_US_ThetaStar_2_epsilon->GetParameter(1), 3);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetPointError(3, fabs(fitL0bar_L0bar_US_ThetaStar_2_epsilon->GetParError(1)), 0);

    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPoint(3, fitL0bar_L0bar_US_ThetaStar_2_epsilon->GetParameter(1), 3);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar*fitL0bar_L0bar_US_ThetaStar_2_epsilon->GetParameter(1)), 0.045);
    ...
    PolarizationGraph_Q[Q_bin-1]->Write(Form("PolarizationGraph_Q_%i", Q_bin-1));
    PolarizationGraph_Q_sys_err[Q_bin-1]->Write(Form("PolarizationGraph_Q_sys_err_%i", Q_bin-1));

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    //plot polarization graphs in bins
    PolarizationGraph_Q_can->cd(Q_bin);
    ...
    PolarizationGraph_Q[Q_bin-1]->SetMarkerStyle(20);
    PolarizationGraph_Q[Q_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Q[Q_bin-1]->SetMarkerColor(kRed);
    PolarizationGraph_Q[Q_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Q[Q_bin-1]->Draw("p e same");

    PolarizationGraph_Q_sys_err[Q_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Q_sys_err[Q_bin-1]->SetFillColorAlpha(kRed, 0.25);
    PolarizationGraph_Q_sys_err[Q_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Q_sys_err[Q_bin-1]->Draw("2 same");

    ZeroLine_eta->Draw("same");

    bin_text[Q_bin-1] = new TPaveText(0.12, 0.85, 0.49, 0.89, "NDC");
    bin_text[Q_bin-1]->SetTextFont(42);
    if(Q_bin == 1) bin_text[Q_bin-1]->AddText("0.0 < Q < 1.5 GeV");
    if(Q_bin == 2) bin_text[Q_bin-1]->AddText("1.5 < Q < 2.0 GeV");
    if(Q_bin == 3) bin_text[Q_bin-1]->AddText("2.0 < Q < 4.0 GeV");
    bin_text[Q_bin-1]->SetFillColorAlpha(0, 0.01);
    bin_text[Q_bin-1]->Draw("same");

    if(Q_bin == 1 ) Polarization_text->Draw("same");

    //---------------------------------------------

    //plot polarization graphs in bins
    PolarizationGraph_Q_epsilon_can->cd(Q_bin);
    ...
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetMarkerStyle(20);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetMarkerColor(kRed);
    PolarizationGraph_Q_epsilon[Q_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Q_epsilon[Q_bin-1]->Draw("p e same");

    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetFillColorAlpha(kRed, 0.25);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Q_epsilon_sys_err[Q_bin-1]->Draw("2 same");

    ZeroLine_Q->Draw("same");
  ...
  PolarizationGraph_Q_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_polarization/L_polarization_Q.png");
  PolarizationGraph_Q_epsilon_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_polarization/L_polarization_Q_epsilon.png");
