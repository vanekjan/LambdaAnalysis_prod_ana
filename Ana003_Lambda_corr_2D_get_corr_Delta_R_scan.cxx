...
bool Ana003_Lambda_corr_2D_get_corr_Delta_R_scan(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  for( unsigned int delta_R_bin = 1; delta_R_bin < 3; delta_R_bin++)
  {
    ...
    if(delta_R_bin == 1)
    {
      ...
      bin_edge = L0_L0bar_cos_theta_star_vs_delta_R_scan_US_hist->GetYaxis()->GetBinUpEdge(bin_max);
    }
    if(delta_R_bin == 2)
    {
      ...
      bin_edge = L0_L0bar_cos_theta_star_vs_delta_R_scan_US_hist->GetYaxis()->GetBinLowEdge(bin_min);
    }
    ...
    L0_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0bar_cosThetaProdPlane_eta_no_corr_less_delta_R_%i.png", delta_R_bin));
    ...
    L0_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0bar_cosThetaProdPlane_eta_less_delta_R_%i.png", delta_R_bin));
    ...
    L0_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0bar_cosThetaProdPlane_eta_subtract_less_delta_R_%i.png", delta_R_bin));
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_US_hist = L0_L0_cos_theta_star_vs_delta_R_scan_US_hist->ProjectionX( Form("proj_US_%i", delta_R_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_hist = L0_L0_cos_theta_star_vs_delta_R_scan_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", delta_R_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_LS_hist = L0_L0_cos_theta_star_vs_delta_R_scan_US_LS_hist->ProjectionX( Form("proj_LS_%i", delta_R_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_LS_hist = L0_L0_cos_theta_star_vs_delta_R_scan_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", delta_R_bin), bin_min, bin_max);
    ...
    L0_L0_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0_cosThetaProdPlane_eta_no_corr_less_delta_R_%i.png", delta_R_bin));
    ...
    L0_L0_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0_cosThetaProdPlane_eta_less_delta_R_%i.png", delta_R_bin));
    ...
    L0_L0_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0_L0_cosThetaProdPlane_eta_subtract_less_delta_R_%i.png", delta_R_bin));
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_US_hist = L0bar_L0bar_cos_theta_star_vs_delta_R_scan_US_hist->ProjectionX( Form("proj_US_%i", delta_R_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_hist = L0bar_L0bar_cos_theta_star_vs_delta_R_scan_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", delta_R_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_R_scan_US_LS_hist->ProjectionX( Form("proj_LS_%i", delta_R_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_R_scan_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", delta_R_bin), bin_min, bin_max);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0bar_L0bar_cosThetaProdPlane_eta_no_corr_less_delta_R_%i.png", delta_R_bin));
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0bar_L0bar_cosThetaProdPlane_eta_less_delta_R_%i.png", delta_R_bin));
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_R_scan/L0bar_L0bar_cosThetaProdPlane_eta_subtract_less_delta_R_%i.png", delta_R_bin));
    ...
    if(delta_R_bin == 1) bin_text[delta_R_bin-1]->AddText(Form("|#DeltaR| < %.2f", bin_edge));
    if(delta_R_bin == 2) bin_text[delta_R_bin-1]->AddText(Form("%.2f < |#DeltaR| < 4", bin_edge));
  ...
  PolarizationGraph_delta_R_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_polarization/L_polarization_delta_R_scan.png");
