...
bool Ana003_Lambda_corr_2D_get_corr_Delta_y(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  for( unsigned int delta_eta_bin = 0; delta_eta_bin < 2; delta_eta_bin++ )
  {
    ...
    ResidualPolarization_delta_eta_hist[delta_eta_bin] = (TH1F*)SysErrSlopeFile->Get(Form("ResidualPolarization_delta_eta_hist_%i", delta_eta_bin));
  }
  ...
  if(cut_type == 0 )
  {
    //SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Delta_y.root", year), "read");
    SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Delta_y_work.root", year), "read");

    //SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Delta_y.root", year), "read");
    SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Delta_y_work.root", year), "read");
  }
  else
  {
    if( cut_type == 1 ) SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Delta_y_work.root", year), "recreate");
    if( cut_type == 2 ) SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Delta_y_work.root", year), "recreate");
  }

  //tight cuts
  //topological cuts
  TF1 *fitL0_L0bar_tight_topo_cuts_Delta_y_US[2];
  TF1 *fitL0_L0_tight_topo_cuts_Delta_y_US[2];
  TF1 *fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[2];

  TF1 *fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[2];
  TF1 *fitL0_L0_tight_topo_cuts_Delta_y_US_LS[2];
  TF1 *fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[2];

  TF1 *fitL0_L0bar_tight_topo_cuts_Delta_y[2];
  TF1 *fitL0_L0_tight_topo_cuts_Delta_y[2];
  TF1 *fitL0bar_L0bar_tight_topo_cuts_Delta_y[2];

  //daughter pT cuts
  TF1 *fitL0_L0bar_tight_pT_cuts_Delta_y_US[2];
  TF1 *fitL0_L0_tight_pT_cuts_Delta_y_US[2];
  TF1 *fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[2];

  TF1 *fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[2];
  TF1 *fitL0_L0_tight_pT_cuts_Delta_y_US_LS[2];
  TF1 *fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[2];

  TF1 *fitL0_L0bar_tight_pT_cuts_Delta_y[2];
  TF1 *fitL0_L0_tight_pT_cuts_Delta_y[2];
  TF1 *fitL0bar_L0bar_tight_pT_cuts_Delta_y[2];

  for( unsigned int delta_eta_bin = 0; delta_eta_bin < 2; delta_eta_bin++)
  {
    if(cut_type == 0 )
    {
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin));
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin));

      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin));

      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_%i", delta_eta_bin));
      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Delta_y_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_%i", delta_eta_bin));


      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin));
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin));

      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin));

      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_%i", delta_eta_bin));
      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Delta_y_%i", delta_eta_bin));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_%i", delta_eta_bin));

    }
    else
    {
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_topo_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      //-----------------------------------------------------------------------------------------

      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0_L0_tight_pT_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);
    }
  ...
  TGraphErrors *PolarizationGraph_delta_eta_sys_err_average[2];
  ...
  Delta_eta_text_1->AddText("|#Delta#it{y}| < 0.5");
  ...
  Delta_eta_text_2->AddText("0.5 < |#Delta#it{y}| < 2.0");
  ...
  for( unsigned int delta_eta_bin = 1; delta_eta_bin < 3; delta_eta_bin++)
  {
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1] = new TGraphErrors(3);
    ...
    L0_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0bar_cosThetaProdPlane_delta_y_%i", delta_eta_bin-1));
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar->GetParameter(0), fitL0_L0bar_US_ThetaStar->GetParameter(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar->GetParError(0));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar->GetParError(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_LS_ThetaStar->GetParameter(0), fitL0_L0bar_US_LS_ThetaStar->GetParameter(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_LS_ThetaStar->GetParError(0));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_LS_ThetaStar->GetParError(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();


      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar->GetParameter(0), fitL0_L0bar_US_ThetaStar->GetParameter(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar->GetParError(0));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar->GetParError(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_LS_ThetaStar->GetParameter(0), fitL0_L0bar_US_LS_ThetaStar->GetParameter(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_LS_ThetaStar->GetParError(0));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_LS_ThetaStar->GetParError(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();

      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    float SysErrSlope_L0_L0bar = fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(1))/fabs(P_L0_L0bar_2);

    SysErr_sum_ME += fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(1))/fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(1));
    SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(1));
    ...
    //float SysErrBackground_L0_L0bar = fabs( P_L0_L0bar_2 - P_L0_L0bar_from_fits)/fabs(P_L0_L0bar_2);

    //SysErr_sum_background += SysErrBackground_L0_L0bar*fabs(P_L0_L0bar_2)/SysErrBackground_L0_L0bar_corr;
    SysErr_sum_background += SysErrBackground_L0_L0bar*fabs(P_L0_L0bar_from_fits)/SysErrBackground_L0_L0bar_corr;
    ...
    if(cut_type == 0)
    {
      ...
      float P_L0_L0bar_tight_topo_cuts_from_fits = fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_topo_cuts_from_fits_err = fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);

      float nLLbar_tight_topo_cuts_fit = fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLLbar_tight_topo_cuts_fit_err = fitL0_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0_L0bar_tight_topo_cuts_from_fits_back = fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_topo_cuts_from_fits_back_err = fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);

      float nLLbar_tight_topo_cuts_back_fit = fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLLbar_tight_topo_cuts_back_fit_err = fitL0_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_topo_cuts_err = fitL0_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
      ...
      float P_L0_L0bar_tight_pT_cuts_from_fits = fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_pT_cuts_from_fits_err = fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);

      float nLLbar_tight_pT_cuts_fit = fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLLbar_tight_pT_cuts_fit_err = fitL0_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0_L0bar_tight_pT_cuts_from_fits_back = fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_pT_cuts_from_fits_back_err = fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);

      float nLLbar_tight_pT_cuts_back_fit = fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLLbar_tight_pT_cuts_back_fit_err = fitL0_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_pT_cuts_err = fitL0_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
    ...
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPoint(1, P_L0_L0bar_from_fits, 1);
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPointError(1, fabs(P_L0_L0bar_from_fits_err), 0);
    ...
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPoint(1, P_L0_L0bar_from_fits, 1);
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPointError(1, fabs(SysErrTot_L0_L0bar*P_L0_L0bar_from_fits), 0.045);
    ...
    L0_L0_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0_cosThetaProdPlane_delta_y_%i", delta_eta_bin-1));
    L0_L0_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0_L0_US_ThetaStar->GetParameter(0), fitL0_L0_US_ThetaStar->GetParameter(1));
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar->GetParError(0));
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar->GetParError(1));
      fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0_L0_US_LS_ThetaStar->GetParameter(0), fitL0_L0_US_LS_ThetaStar->GetParameter(1));
      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_LS_ThetaStar->GetParError(0));
      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_LS_ThetaStar->GetParError(1));
      fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();

      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0_L0_US_ThetaStar->GetParameter(0), fitL0_L0_US_ThetaStar->GetParameter(1));
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar->GetParError(0));
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar->GetParError(1));
      fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0_L0_US_LS_ThetaStar->GetParameter(0), fitL0_L0_US_LS_ThetaStar->GetParameter(1));
      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_LS_ThetaStar->GetParError(0));
      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_LS_ThetaStar->GetParError(1));
      fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();

      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    float SysErrSlope_L0_L0 = fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(2))/fabs(P_L0_L0_2);

    SysErr_sum_ME += fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(2))/fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(2));
    SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(2));
    ...
    //float SysErrBackground_L0_L0 = fabs( P_L0_L0_2 - P_L0_L0_from_fits)/fabs(P_L0_L0_2);

    //SysErr_sum_background += SysErrBackground_L0_L0*fabs(P_L0_L0_2)/SysErrBackground_L0_L0_corr;
    SysErr_sum_background += SysErrBackground_L0_L0*fabs(P_L0_L0_from_fits)/SysErrBackground_L0_L0_corr;
    ...
    if(cut_type == 0)
    {
      ...
      float P_L0_L0_tight_topo_cuts_from_fits = fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_topo_cuts_from_fits_err = fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nLL_tight_topo_cuts_fit = fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLL_tight_topo_cuts_fit_err = fitL0_L0_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0_L0_tight_topo_cuts_from_fits_back = fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_topo_cuts_from_fits_back_err = fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nLL_tight_topo_cuts_back_fit = fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLL_tight_topo_cuts_back_fit_err = fitL0_L0_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0_L0_tight_topo_cuts = fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_topo_cuts_err = fitL0_L0_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
      ...
      float P_L0_L0_tight_pT_cuts_from_fits = fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_pT_cuts_from_fits_err = fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nLL_tight_pT_cuts_fit = fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLL_tight_pT_cuts_fit_err = fitL0_L0_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0_L0_tight_pT_cuts_from_fits_back = fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_pT_cuts_from_fits_back_err = fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nLL_tight_pT_cuts_back_fit = fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLL_tight_pT_cuts_back_fit_err = fitL0_L0_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0_L0_tight_pT_cuts = fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_pT_cuts_err = fitL0_L0_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
    ...
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPoint(2, P_L0_L0_from_fits, 2);
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPointError(2, fabs(P_L0_L0_from_fits_err), 0);
    ...
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPoint(2, P_L0_L0_from_fits, 2);
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPointError(2, fabs(SysErrTot_L0_L0*P_L0_L0_from_fits), 0.045);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0bar_L0bar_cosThetaProdPlane_delta_y_%i", delta_eta_bin-1));
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar->GetParameter(0), fitL0bar_L0bar_US_ThetaStar->GetParameter(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar->GetParError(0));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar->GetParError(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_LS_ThetaStar->GetParameter(0), fitL0bar_L0bar_US_LS_ThetaStar->GetParameter(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_LS_ThetaStar->GetParError(0));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_LS_ThetaStar->GetParError(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();


      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar->GetParameter(0), fitL0bar_L0bar_US_ThetaStar->GetParameter(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar->GetParError(0));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar->GetParError(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_LS_ThetaStar->GetParameter(0), fitL0bar_L0bar_US_LS_ThetaStar->GetParameter(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_LS_ThetaStar->GetParError(0));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_LS_ThetaStar->GetParError(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();


      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    float SysErrSlope_L0bar_L0bar = fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(3))/fabs(P_L0bar_L0bar_2);

    SysErr_sum_ME += fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(3))/fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(3));
    SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinError(3));
    ...
    float SysErrBackground_L0bar_L0bar_work = ( fabs( P_L0bar_L0bar_2 - P_L0bar_L0bar_from_fits) - SysErrBackground_L0bar_L0bar_corr )/fabs(P_L0bar_L0bar_from_fits);
    ...
    //float SysErrBackground_L0bar_L0bar = fabs( P_L0bar_L0bar_2 - P_L0bar_L0bar_from_fits)/fabs(P_L0bar_L0bar_2);

    //SysErr_sum_background += SysErrBackground_L0bar_L0bar*fabs(P_L0bar_L0bar_2)/SysErrBackground_L0bar_L0bar_corr;
    SysErr_sum_background += SysErrBackground_L0bar_L0bar*fabs(P_L0bar_L0bar_from_fits)/SysErrBackground_L0bar_L0bar_corr;
    ...
    if(cut_type == 0)
    {
      ...
      float P_L0bar_L0bar_tight_topo_cuts_from_fits = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_topo_cuts_from_fits_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

      float nLbarLbar_tight_topo_cuts_fit = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLbarLbar_tight_topo_cuts_fit_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0bar_L0bar_tight_topo_cuts_from_fits_back = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_topo_cuts_from_fits_back_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

      float nLbarLbar_tight_topo_cuts_back_fit = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLbarLbar_tight_topo_cuts_back_fit_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0bar_L0bar_tight_topo_cuts = fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_topo_cuts_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
      ...
      float P_L0bar_L0bar_tight_pT_cuts_from_fits = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_pT_cuts_from_fits_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

      float nLbarLbar_tight_pT_cuts_fit = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nLbarLbar_tight_pT_cuts_fit_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_L0bar_L0bar_tight_pT_cuts_from_fits_back = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_pT_cuts_from_fits_back_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

      float nLbarLbar_tight_pT_cuts_back_fit = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nLbarLbar_tight_pT_cuts_back_fit_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_L0bar_L0bar_tight_pT_cuts = fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_pT_cuts_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
    ...
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPoint(3, P_L0bar_L0bar_from_fits, 3);
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPointError(3, fabs(P_L0bar_L0bar_from_fits_err), 0);
    ...
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPoint(3, P_L0bar_L0bar_from_fits, 3);
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar*P_L0bar_L0bar_from_fits), 0.045);
    ...
    PolarizationGraph_delta_eta[delta_eta_bin-1]->Write(Form("PolarizationGraph_delta_y_%i", delta_eta_bin-1));
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->Write(Form("PolarizationGraph_delta_y_sys_err_%i", delta_eta_bin-1));
  ...
  for( unsigned int delta_eta_bin = 1; delta_eta_bin < 3; delta_eta_bin++)
  {
    ...
    //float L0L0bar_SysErrTot_weights_work_relat = SysErrTot_weights_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1); //point 1 is LLbar
    float L0L0bar_SysErrTot_weights_work_relat = SysErrTot_weights_from_fits_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1); //point 1 is LLbar
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPoint(1, PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1), 1);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPointError(1, L0L0bar_SysErrTot_weights*PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1), 0.045);


    //L-L

    //float L0L0_SysErrTot_weights_work_relat = SysErrTot_weights_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(2); //point 1 is LLbar
    float L0L0_SysErrTot_weights_work_relat = SysErrTot_weights_from_fits_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(2); //point 1 is LLbar
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPoint(2, PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(2), 2);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPointError(2, L0L0_SysErrTot_weights*PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(2), 0.045);


    //Lbar-Lbar

    //float L0barL0bar_SysErrTot_weights_work_relat = SysErrTot_weights_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(3); //point 1 is LLbar
    float L0barL0bar_SysErrTot_weights_work_relat = SysErrTot_weights_from_fits_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(3); //point 1 is LLbar
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPoint(3, PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(3), 3);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPointError(3, L0barL0bar_SysErrTot_weights*PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(3), 0.045);


    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->Write(Form("PolarizationGraph_delta_y_sys_err_average_%i", delta_eta_bin-1));
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetMarkerSize(2);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetFillColorAlpha(kRed, 0.25);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetLineColor(kRed);
    if(year != 2016) PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->Draw("2 same");

    ZeroLine_eta->Draw("same");

    bin_text[delta_eta_bin-1] = new TPaveText(0.12, 0.85, 0.49, 0.89, "NDC");
    bin_text[delta_eta_bin-1]->SetTextFont(42);
    if(delta_eta_bin == 1) bin_text[delta_eta_bin-1]->AddText("|#it{y}| < 0.5");
    if(delta_eta_bin == 2) bin_text[delta_eta_bin-1]->AddText("0.5 < |#it{y}| < 2.0");
  ...
  PolarizationGraph_delta_eta_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_polarization/L_polarization_delta_eta.png");
