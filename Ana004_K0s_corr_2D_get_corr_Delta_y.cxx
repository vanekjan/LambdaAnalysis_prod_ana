...
bool Ana004_K0s_corr_2D_get_corr_Delta_y(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  {
    SysErrSlope_delta_eta_hist[delta_eta_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_K0s_delta_eta_hist_%i", delta_eta_bin));
    ResidualPolarization_delta_eta_hist[delta_eta_bin] = (TH1F*)SysErrSlopeFile->Get(Form("ResidualPolarization_K0s_delta_eta_hist_%i", delta_eta_bin));
  }
  ...
  if(cut_type == 0 )
  {
    SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_topo_cuts_Delta_y_work.root", year), "read");

    SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_pT_cuts_Delta_y_work.root", year), "read");
  }
  else
  {
    if( cut_type == 1 ) SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_topo_cuts_Delta_y_work.root", year), "recreate");
    if( cut_type == 2 ) SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_pT_cuts_Delta_y_work.root", year), "recreate");
  }


  //tight cuts
  //topological cuts
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_y_US[2];
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[2];
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_y[2];


  //daughter pT cuts
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_y_US[2];
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[2];
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_y[2];
  ...
  for( unsigned int delta_eta_bin = 0; delta_eta_bin < 2; delta_eta_bin++)
  {
    if(cut_type == 0 )
    {
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_%i", delta_eta_bin));


      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin));
      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_%i", delta_eta_bin));
    }
    else
    {
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);

      //-----------------------------------------------------------------------------------------

      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_y_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin]->SetParameters(100, 0.5);
    }
  ...
  TFile *out_file = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/Polarization/%i/Polarization_K0s_Delta_y.root", year), "recreate");
  ...
  TH2F *K0s_K0s_cos_theta_star_vs_delta_eta_US_hist = (TH2F*)inFile->Get("K0s_K0s_cos_theta_star_vs_delta_eta_US_hist");

  TH2F *K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_hist = (TH2F*)inFile->Get("K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_hist");

  //--------------------------------------------------------

  //mixed event
  TH2F *K0s_K0s_cos_theta_star_vs_delta_eta_US_ME_hist = (TH2F*)inFile->Get("K0s_K0s_cos_theta_star_vs_delta_eta_US_ME_hist");

  TH2F *K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_ME_hist = (TH2F*)inFile->Get("K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_ME_hist");
  ...
  for( unsigned int delta_eta_bin = 1; delta_eta_bin < 3; delta_eta_bin++)
  {
    ...
    PolarizationGraph_delta_eta[delta_eta_bin-1] = new TGraphErrors(1);
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1] = new TGraphErrors(1);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1] = new TGraphErrors(1);
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_eta_US_hist = K0s_K0s_cos_theta_star_vs_delta_eta_US_hist->ProjectionX( Form("proj_US_%i", delta_eta_bin), delta_eta_bin, delta_eta_bin);
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_eta_ME_hist = K0s_K0s_cos_theta_star_vs_delta_eta_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", delta_eta_bin), delta_eta_bin, delta_eta_bin);
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_eta_LS_hist = K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_hist->ProjectionX( Form("proj_LS_%i", delta_eta_bin), delta_eta_bin, delta_eta_bin);
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_eta_ME_LS_hist = K0s_K0s_cos_theta_star_vs_delta_eta_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", delta_eta_bin), delta_eta_bin, delta_eta_bin);
    ...
    K0s_K0s_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_y/K0s_K0s_cosThetaProdPlane_eta_no_corr_less_delta_eta_%i.png", delta_eta_bin));
    ...
    K0s_K0s_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_y/K0s_K0s_cosThetaProdPlane_eta_less_delta_eta_%i.png", delta_eta_bin));
    ...
    if(cut_type == 1)
    {
      ...
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar->GetParameter(0), fitK0s_K0s_US_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_LS_ThetaStar->GetParameter(0), fitK0s_K0s_US_LS_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_LS_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_LS_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar_2->GetParameter(0), fitK0s_K0s_US_ThetaStar_2->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar_2->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar_2->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar->GetParameter(0), fitK0s_K0s_US_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->Write();


      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_LS_ThetaStar->GetParameter(0), fitK0s_K0s_US_LS_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_LS_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_LS_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar_2->GetParameter(0), fitK0s_K0s_US_ThetaStar_2->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar_2->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar_2->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->Write();
    }
    ...
    K0s_K0s_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_y/K0s_K0s_cosThetaProdPlane_eta_subtract_less_delta_eta_%i.png", delta_eta_bin));
    ...
    //slope
    //float SysErrSlope_K0s_K0s = SysErrSlope_delta_eta_hist[delta_eta_bin-1]->GetBinContent(1);
    float SysErrSlope_K0s_K0s = fabs(ResidualPolarization_delta_eta_hist[delta_eta_bin-1]->GetBinContent(1))/fabs(P_K0s_K0s_2);
    ...
    float SysErrBackground_K0s_K0s_work = ( fabs( P_K0s_K0s_2 - P_K0s_K0s_from_fits) - SysErrBackground_K0s_K0s_corr )/fabs(P_K0s_K0s_from_fits);
    ...
    if(cut_type == 0)
    {
      ...
      float P_K0s_K0s_tight_topo_cuts_from_fits = fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_from_fits_err = fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_topo_cuts_fit = fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_topo_cuts_fit_err = fitK0s_K0s_tight_topo_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_K0s_K0s_tight_topo_cuts_from_fits_back = fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_from_fits_back_err = fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_topo_cuts_back_fit = fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_topo_cuts_back_fit_err = fitK0s_K0s_tight_topo_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_K0s_K0s_tight_topo_cuts = fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_err = fitK0s_K0s_tight_topo_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
      ...
      float P_K0s_K0s_tight_pT_cuts_from_fits = fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_from_fits_err = fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_pT_cuts_fit = fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_pT_cuts_fit_err = fitK0s_K0s_tight_pT_cuts_Delta_y_US[delta_eta_bin-1]->GetParError(0);


      float P_K0s_K0s_tight_pT_cuts_from_fits_back = fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_from_fits_back_err = fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_pT_cuts_back_fit = fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_pT_cuts_back_fit_err = fitK0s_K0s_tight_pT_cuts_Delta_y_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_K0s_K0s_tight_pT_cuts = fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_err = fitK0s_K0s_tight_pT_cuts_Delta_y[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
    ...
    //PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_2, 4);
    //PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPointError(1, fabs(P_K0s_K0s_err_2), 0);

    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_from_fits, 4);
    PolarizationGraph_delta_eta[delta_eta_bin-1]->SetPointError(1, fabs(P_K0s_K0s_from_fits_err), 0);


    //PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_2, 4);
    //PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPointError(1, fabs(SysErrTot_K0s_K0s*P_K0s_K0s_2), 0.045);

    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_from_fits, 4);
    PolarizationGraph_delta_eta_sys_err[delta_eta_bin-1]->SetPointError(1, fabs(SysErrTot_K0s_K0s*P_K0s_K0s_from_fits), 0.045);
  ...
  for( unsigned int delta_eta_bin = 1; delta_eta_bin < 3; delta_eta_bin++)
  {
    ...
    //float K0sK0s_SysErrTot_weights_work_relat = SysErrTot_weights_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1);
    float K0sK0s_SysErrTot_weights_work_relat = SysErrTot_weights_from_fits_work/PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1);
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPoint(1, PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1), 4);
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->SetPointError(1, K0sK0s_SysErrTot_weights*PolarizationGraph_delta_eta[delta_eta_bin-1]->GetPointX(1), 0.045);
    ...
    PolarizationGraph_delta_eta_sys_err_average[delta_eta_bin-1]->Draw("2 same");
  ...
  PolarizationGraph_delta_eta_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_polarization/K0s_polarization_delta_eta.png");
