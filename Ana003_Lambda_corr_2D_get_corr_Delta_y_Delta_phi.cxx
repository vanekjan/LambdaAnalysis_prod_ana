...
bool Ana003_Lambda_corr_2D_get_corr_Delta_y_Delta_phi(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  if(cut_type == 0)
  {
    if(year == 2012)
    {
      ...
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/20240823_tests/ProdPlane_Lambda_ana_cuts_eff_corr.root", year), "read"); //analysis cuts
