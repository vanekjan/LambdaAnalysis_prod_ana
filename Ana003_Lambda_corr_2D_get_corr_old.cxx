...
bool Ana003_Lambda_corr_2D_get_corr(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  if(cut_type == 0)
  {
    if(year == 2012)
    {
      ...
      //updated ME for LbarLbar background
      //original full production, ana cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_full.root", year), "read"); //analysis cuts

      //new production, new ME method
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_full.root", year), "read"); //analysis cuts

      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_012025_fixed_Lbar_fit.root", year), "read"); //analysis cuts

      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_DCA_pair_0.5.root", year), "read"); //analysis cuts

      //new production, ana cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_new_prod.root", year), "read"); //analysis cuts

      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_ME_0.07.root", year), "read"); //analysis cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_ME_0.1.root", year), "read"); //analysis cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_ME_0.2.root", year), "read"); //analysis cuts
      //LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/ProdPlane_Lambda_ana_cuts_ME_phi_0.05.root", year), "read"); //analysis cuts

      //old ME with reweights
      LLbarOutFile = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/%i/old_Lambda/ProdPlane_Lambda_ana_cuts_old_ME_work.root", year), "read"); //analysis cuts

      //old ME for LbarLbar background (bad)
      //original full production, ana cuts
      //LLbarOutFile = new TFile("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/output/ProdPlane/old/ProdPlane_Lambda_ana_cuts_full.root", "read"); //analysis cuts
  ...
  float P_L0_L0bar_from_fits = P_L0_L0bar - nLLbar_back/(nLLbar-nLLbar_back)*P_L0_L0bar_back;
  float P_L0_L0bar_from_fits_err = sqrt( P_L0_L0bar_err*P_L0_L0bar_err + nLLbar_back/(nLLbar-nLLbar_back)*nLLbar_back/(nLLbar-nLLbar_back)*P_L0_L0bar_back_err*P_L0_L0bar_back_err );
  ...
  if(cut_type == 0)
  {
    P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts->GetParameter(1)/(L0_alpha*L0bar_alpha);
    ...
    P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts->GetParameter(1)/(L0_alpha*L0bar_alpha);
  ...
  //background subtraction
  float P_L0_L0_from_fits = P_L0_L0 - nLL_back/(nLL-nLL_back)*P_L0_L0_back;
  float P_L0_L0_from_fits_err = sqrt( P_L0_L0_err*P_L0_L0_err + nLL_back/(nLL-nLL_back)*nLL_back/(nLL-nLL_back)*P_L0_L0_back_err*P_L0_L0_back_err );
  ...
  TPaveText *L0_L0_text_2 = new TPaveText(0.47, 0.15, 0.85, 0.53,  "NDC");
  ...
  //background subtraction
  float P_L0bar_L0bar_from_fits = P_L0bar_L0bar - nLbarLbar_back/(nLbarLbar-nLbarLbar_back)*P_L0bar_L0bar_back;
  float P_L0bar_L0bar_from_fits_err = sqrt( P_L0bar_L0bar_err*P_L0bar_L0bar_err + nLbarLbar_back/(nLbarLbar-nLbarLbar_back)*nLbarLbar_back/(nLbarLbar-nLbarLbar_back)*P_L0bar_L0bar_back_err*P_L0bar_L0bar_back_err );
  ...
  DefaultHist->GetYaxis()->SetRangeUser(0.01, 4.99);
  //DefaultHist->GetYaxis()->SetNdivisions(505);
  DefaultHist->GetYaxis()->SetNdivisions(06);
  ...
  TLine *ZeroLine = new TLine(0,0.01,0,4.99);
