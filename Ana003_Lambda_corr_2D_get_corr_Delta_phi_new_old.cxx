...
bool Ana003_Lambda_corr_2D_get_corr_Delta_phi_new(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  for( unsigned int delta_phi_bin = 0; delta_phi_bin < 3; delta_phi_bin++ )
  {
    ...
    ResidualPolarization_delta_phi_less_hist[delta_phi_bin] = (TH1F*)SysErrSlopeFile->Get(Form("ResidualPolarization_delta_phi_less_hist_%i", delta_phi_bin));
    ResidualPolarization_delta_phi_more_hist[delta_phi_bin] = (TH1F*)SysErrSlopeFile->Get(Form("ResidualPolarization_delta_phi_more_hist_%i", delta_phi_bin));
  }
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_US_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LLbar_US", bin_min, bin_middle);
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_ME_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LLbar_US_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_LS_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LLbar_LS_%i", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_ME_LS_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LLbar_LS_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  L0_L0bar_cosThetaProdPlane_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 0));
  ...
  L0_L0bar_cosThetaProdPlane_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_delta_phi_new_%i.png", 0));
  ...
  L0_L0bar_cosThetaProdPlane_US_hist->SetMinimum(0);
  L0_L0bar_cosThetaProdPlane_US_hist->Write(Form("L0_L0bar_cosThetaProdPlane_delta_phi_%i", 0));
  L0_L0bar_cosThetaProdPlane_US_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0_L0bar = SysErrSlope_delta_phi_less_hist[0]->GetBinContent(1);
  float SysErrSlope_L0_L0bar = fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(1))/fabs(P_L0_L0bar_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(1))/fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(1));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(1));
  ...
  if(cut_type == 0)
  {
    float P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->GetParameter(1)/(L0_alpha*L0bar_alpha);
    float P_L0_L0bar_tight_topo_cuts_err = fitL0_L0bar_tight_topo_cuts_Delta_phi[0]->GetParError(1)/(L0_alpha*L0bar_alpha);
    ...
    SysErr_tight_topo_cuts_L0_L0bar = 0;
    ...
    float P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->GetParameter(1)/(L0_alpha*L0bar_alpha);
    float P_L0_L0bar_tight_pT_cuts_err = fitL0_L0bar_tight_pT_cuts_Delta_phi[0]->GetParError(1)/(L0_alpha*L0bar_alpha);
    ...
    SysErr_tight_pT_cuts_L0_L0bar = 0;
  ...
  L0_L0bar_cosThetaProdPlane_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 0));


  PolarizationGraph_delta_phi[0]->SetPoint(1, P_L0_L0bar_2, 1);
  PolarizationGraph_delta_phi[0]->SetPointError(1, fabs(P_L0_L0bar_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[0]->SetPoint(1, P_L0_L0bar_2, 1);
  PolarizationGraph_delta_phi_sys_err[0]->SetPointError(1, fabs(SysErrTot_L0_L0bar*P_L0_L0bar_2), 0.045);

  //____________________________________________________________________________________________________________________________________________________________________________________________________________


  TCanvas *L0_L0bar_cosThetaProdPlane_no_corr_2_can = new TCanvas("L0_L0bar_cosThetaProdPlane_no_corr_2_can", "L0_L0bar_cosThetaProdPlane_no_corr_2_can", 1200, 1000);

  L0_L0bar_cosThetaProdPlane_no_corr_2_can->cd();

  TH1D *L0_L0bar_cosThetaProdPlane_US_2_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LLbar_US_2", bin_middle+1, bin_max);
  ...
  //ME here just for plotting, used loser
  TH1D *L0_L0bar_cosThetaProdPlane_ME_2_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LLbar_US_ME_2", bin_middle+1, bin_max);
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_LS_2_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LLbar_LS_2", bin_middle+1, bin_max);
  ...
  TH1D *L0_L0bar_cosThetaProdPlane_ME_LS_2_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LLbar_LS_ME_2", bin_middle+1, bin_max);
  ...
  L0_L0bar_cosThetaProdPlane_no_corr_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 1));

  //----------------------------------------------------------------------------------------------------

  TCanvas *L0_L0bar_cosThetaProdPlane_2_can = new TCanvas("L0_L0bar_cosThetaProdPlane_2_can", "L0_L0bar_cosThetaProdPlane_2_can", 1200, 1000);
  ...
  L0_L0bar_cosThetaProdPlane_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_delta_phi_new_%i.png", 1));

  //----------------------------------------------------------------------

  TCanvas *L0_L0bar_cosThetaProdPlane_2_can_2 = new TCanvas("L0_L0bar_cosThetaProdPlane_2_can_2", "L0_L0bar_cosThetaProdPlane_2_can_2", 1200, 1000);

  L0_L0bar_cosThetaProdPlane_2_can_2->cd();

  L0_L0bar_cosThetaProdPlane_US_2_hist->Add(L0_L0bar_cosThetaProdPlane_LS_2_hist, -1);
  L0_L0bar_cosThetaProdPlane_US_2_hist->SetMinimum(0);
  L0_L0bar_cosThetaProdPlane_US_2_hist->Write(Form("L0_L0bar_cosThetaProdPlane_delta_phi_%i", 1));
  L0_L0bar_cosThetaProdPlane_US_2_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->SetParameters(fit_2_L0_L0bar_US_ThetaStar_2->GetParameter(0), fit_2_L0_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->SetParError(0, fit_2_L0_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->SetParError(1, fit_2_L0_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->SetParameters(fit_2_L0_L0bar_US_ThetaStar_2->GetParameter(0), fit_2_L0_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->SetParError(0, fit_2_L0_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->SetParError(1, fit_2_L0_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0_L0bar_2 = SysErrSlope_delta_phi_more_hist[0]->GetBinContent(1);
  float SysErrSlope_L0_L0bar_2 = fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(1))/fabs(P_2_L0_L0bar_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(1))/fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(1));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(1));

  //----------------------------

  //background subtraction
  float P_2_L0_L0bar_from_fits = P_2_L0_L0bar - nLLbar_2_back/nLLbar_2*P_L0_L0bar_back;
  float P_2_L0_L0bar_from_fits_err = sqrt( P_2_L0_L0bar_err*P_2_L0_L0bar_err + nLLbar_2_back/nLLbar_2*nLLbar_2_back/nLLbar_2*P_2_L0_L0bar_back_err*P_2_L0_L0bar_back_err );

  //statistical error correction for systematic error
  float SysErrBackground_L0_L0bar_corr_2 = sqrt( fabs( P_2_L0_L0bar_err_2*P_2_L0_L0bar_err_2 - P_2_L0_L0bar_from_fits_err*P_2_L0_L0bar_from_fits_err ) );

  float SysErrBackground_L0_L0bar_work_2 = ( fabs( P_2_L0_L0bar_2 - P_2_L0_L0bar_from_fits) - SysErrBackground_L0_L0bar_corr_2 )/fabs(P_2_L0_L0bar_2);

  float SysErrBackground_L0_L0bar_2 = 0;

  if( SysErrBackground_L0_L0bar_work_2 > 0 ) SysErrBackground_L0_L0bar_2 = SysErrBackground_L0_L0bar_work_2; //store sys. err. only if it is larger than statistical fluctuations

  SysErr_sum_background += SysErrBackground_L0_L0bar_2*fabs(P_2_L0_L0bar_2)/SysErrBackground_L0_L0bar_corr_2;
  SysErr_sum_of_w_background += 1./SysErrBackground_L0_L0bar_corr_2;

  //----------------------------

  //cuts variation
  float SysErr_tight_cuts_L0_L0bar_2 = 0;

  float SysErr_tight_topo_cuts_L0_L0bar_2 = 0;
  float SysErr_tight_pT_cuts_L0_L0bar_2 = 0;

  if(cut_type == 0)
  {
    float P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
    float P_L0_L0bar_tight_topo_cuts_err = fitL0_L0bar_tight_topo_cuts_Delta_phi[1]->GetParError(1)/(L0_alpha*L0bar_alpha);

    //statistical error correction for systematic error
    float SysErr_tight_topo_cuts_L0_L0bar_corr = sqrt( fabs( P_L0_L0bar_err_2*P_L0_L0bar_err_2 - P_L0_L0bar_tight_topo_cuts_err*P_L0_L0bar_tight_topo_cuts_err ) );

    float SysErr_tight_topo_cuts_L0_L0bar_work = ( fabs( P_2_L0_L0bar_2 - P_L0_L0bar_tight_topo_cuts) - SysErr_tight_topo_cuts_L0_L0bar_corr )/fabs(P_2_L0_L0bar_2);

    SysErr_tight_topo_cuts_L0_L0bar_2 = 0;

    if( SysErr_tight_topo_cuts_L0_L0bar_work > 0 ) SysErr_tight_topo_cuts_L0_L0bar_2 = SysErr_tight_topo_cuts_L0_L0bar_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_topo_cuts += SysErr_tight_topo_cuts_L0_L0bar_2*fabs(P_2_L0_L0bar_2)/SysErr_tight_topo_cuts_L0_L0bar_corr;
    SysErr_sum_of_w_topo_cuts += 1./SysErr_tight_topo_cuts_L0_L0bar_corr;


    float P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
    float P_L0_L0bar_tight_pT_cuts_err = fitL0_L0bar_tight_pT_cuts_Delta_phi[1]->GetParError(1)/(L0_alpha*L0bar_alpha);

    //statistical error correction for systematic error
    float SysErr_tight_pT_cuts_L0_L0bar_corr = sqrt( fabs( P_L0_L0bar_err_2*P_L0_L0bar_err_2 - P_L0_L0bar_tight_pT_cuts_err*P_L0_L0bar_tight_pT_cuts_err ) );

    float SysErr_tight_pT_cuts_L0_L0bar_work = ( fabs( P_2_L0_L0bar_2 - P_L0_L0bar_tight_pT_cuts) - SysErr_tight_pT_cuts_L0_L0bar_corr )/fabs(P_2_L0_L0bar_2);

    SysErr_tight_pT_cuts_L0_L0bar_2 = 0;

    if( SysErr_tight_pT_cuts_L0_L0bar_work > 0 ) SysErr_tight_pT_cuts_L0_L0bar_2 = SysErr_tight_pT_cuts_L0_L0bar_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_pT_cut += SysErr_tight_pT_cuts_L0_L0bar_2*fabs(P_2_L0_L0bar_2)/SysErr_tight_pT_cuts_L0_L0bar_corr;
    SysErr_sum_of_w_pT_cut += 1./SysErr_tight_pT_cuts_L0_L0bar_corr;


    SysErr_tight_cuts_L0_L0bar_2 = sqrt(SysErr_tight_topo_cuts_L0_L0bar_2*SysErr_tight_topo_cuts_L0_L0bar_2 + SysErr_tight_pT_cuts_L0_L0bar_2*SysErr_tight_pT_cuts_L0_L0bar_2);
    //SysErr_tight_cuts_L0_L0bar = SysErr_tight_topo_cuts_L0_L0bar;
    //SysErr_tight_cuts_L0_L0bar = SysErr_tight_pT_cuts_L0_L0bar;
  }
  ...
  //total
  //float SysErrTot_L0_L0bar = sqrt( sysErr_alpha_L0_L0bar*sysErr_alpha_L0_L0bar + SysErrSlope_L0_L0bar*SysErrSlope_L0_L0bar + SysErrBackground_L0_L0bar*SysErrBackground_L0_L0bar  );
  float SysErrTot_L0_L0bar_2 = sqrt( sysErr_alpha_L0_L0bar*sysErr_alpha_L0_L0bar + SysErrSlope_L0_L0bar_2*SysErrSlope_L0_L0bar_2 + SysErrBackground_L0_L0bar_2*SysErrBackground_L0_L0bar_2 + SysErr_tight_cuts_L0_L0bar_2*SysErr_tight_cuts_L0_L0bar_2 );
  ...
  L0_L0bar_cosThetaProdPlane_2_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0bar_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 1));

  PolarizationGraph_delta_phi[1]->SetPoint(1, P_2_L0_L0bar_2, 1);
  PolarizationGraph_delta_phi[1]->SetPointError(1, fabs(P_2_L0_L0bar_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[1]->SetPoint(1, P_2_L0_L0bar_2, 1);
  PolarizationGraph_delta_phi_sys_err[1]->SetPointError(1, fabs(SysErrTot_L0_L0bar_2*P_2_L0_L0bar_2), 0.045);
  ...
  TH1D *L0_L0_cosThetaProdPlane_US_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LL_US", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  //ME here just for plotting, used loser
  TH1D *L0_L0_cosThetaProdPlane_ME_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LL_US_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0_L0_cosThetaProdPlane_LS_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LL_LS_%i", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0_L0_cosThetaProdPlane_ME_LS_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LL_LS_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  L0_L0_cosThetaProdPlane_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 0));
  ...
  L0_L0_cosThetaProdPlane_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_delta_phi_new_%i.png", 0));

  //----------------------------------------------------------------------

  TCanvas *L0_L0_cosThetaProdPlane_can_2 = new TCanvas("L0_L0_cosThetaProdPlane_can_2", "L0_L0_cosThetaProdPlane_can_2", 1200, 1000);

  L0_L0_cosThetaProdPlane_can_2->cd();

  L0_L0_cosThetaProdPlane_US_hist->Add(L0_L0_cosThetaProdPlane_LS_hist, -1);
  L0_L0_cosThetaProdPlane_US_hist->SetMinimum(0);
  L0_L0_cosThetaProdPlane_US_hist->Write(Form("L0_L0_cosThetaProdPlane_delta_phi_%i", 0));
  L0_L0_cosThetaProdPlane_US_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0_L0_tight_topo_cuts_Delta_phi[0]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
    fitL0_L0_tight_topo_cuts_Delta_phi[0]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
    fitL0_L0_tight_topo_cuts_Delta_phi[0]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
    fitL0_L0_tight_topo_cuts_Delta_phi[0]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0_L0_tight_pT_cuts_Delta_phi[0]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
    fitL0_L0_tight_pT_cuts_Delta_phi[0]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
    fitL0_L0_tight_pT_cuts_Delta_phi[0]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
    fitL0_L0_tight_pT_cuts_Delta_phi[0]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0_L0 = SysErrSlope_delta_phi_less_hist[0]->GetBinContent(2);
  float SysErrSlope_L0_L0 = fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(2))/fabs(P_L0_L0_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(2))/fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(2));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(2));
  ...
  if(cut_type == 0)
  {
    float P_L0_L0_tight_topo_cuts = fitL0_L0_tight_topo_cuts_Delta_phi[0]->GetParameter(1)/(L0_alpha*L0_alpha);
    float P_L0_L0_tight_topo_cuts_err = fitL0_L0_tight_topo_cuts_Delta_phi[0]->GetParError(1)/(L0_alpha*L0_alpha);
    ...
    SysErr_tight_topo_cuts_L0_L0 = 0;
    ...
    float P_L0_L0_tight_pT_cuts = fitL0_L0_tight_pT_cuts_Delta_phi[0]->GetParameter(1)/(L0_alpha*L0_alpha);
    float P_L0_L0_tight_pT_cuts_err = fitL0_L0_tight_pT_cuts_Delta_phi[0]->GetParError(1)/(L0_alpha*L0_alpha);
  ...
  L0_L0_cosThetaProdPlane_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 0));


  PolarizationGraph_delta_phi[0]->SetPoint(2, P_L0_L0_2, 2);
  PolarizationGraph_delta_phi[0]->SetPointError(2, fabs(P_L0_L0_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[0]->SetPoint(2, P_L0_L0_2, 2);
  PolarizationGraph_delta_phi_sys_err[0]->SetPointError(2, fabs(SysErrTot_L0_L0*P_L0_L0_2), 0.045);

  //____________________________________________________________________________________________________________________________________________________________________________________________________________


  TCanvas *L0_L0_cosThetaProdPlane_no_corr_2_can = new TCanvas("L0_L0_cosThetaProdPlane_no_corr_2_can", "L0_L0_cosThetaProdPlane_no_corr_2_can", 1200, 1000);

  L0_L0_cosThetaProdPlane_no_corr_2_can->cd();

  TH1D *L0_L0_cosThetaProdPlane_US_2_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LL_US_2", bin_middle+1, bin_max);
  ...
  //ME here just for plotting, used loser
  TH1D *L0_L0_cosThetaProdPlane_ME_2_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LL_US_ME_2", bin_middle+1, bin_max);
  ...
  TH1D *L0_L0_cosThetaProdPlane_LS_2_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LL_LS_2", bin_middle+1, bin_max);
  ...
  TH1D *L0_L0_cosThetaProdPlane_ME_LS_2_hist = L0_L0_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LL_LS_ME_2", bin_middle+1, bin_max);
  ...
  L0_L0_cosThetaProdPlane_no_corr_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 1));
  ...
  L0_L0_cosThetaProdPlane_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_delta_phi_new_%i.png", 1));

  //----------------------------------------------------------------------

  TCanvas *L0_L0_cosThetaProdPlane_2_can_2 = new TCanvas("L0_L0_cosThetaProdPlane_2_can_2", "L0_L0_cosThetaProdPlane_2_can_2", 1200, 1000);

  L0_L0_cosThetaProdPlane_2_can_2->cd();

  L0_L0_cosThetaProdPlane_US_2_hist->Add(L0_L0_cosThetaProdPlane_LS_2_hist, -1);
  L0_L0_cosThetaProdPlane_US_2_hist->SetMinimum(0);
  L0_L0_cosThetaProdPlane_US_2_hist->Write(Form("L0_L0_cosThetaProdPlane_delta_phi_%i", 1));
  L0_L0_cosThetaProdPlane_US_2_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0_L0_tight_topo_cuts_Delta_phi[1]->SetParameters(fit_2_L0_L0_US_ThetaStar_2->GetParameter(0), fit_2_L0_L0_US_ThetaStar_2->GetParameter(1));
    fitL0_L0_tight_topo_cuts_Delta_phi[1]->SetParError(0, fit_2_L0_L0_US_ThetaStar_2->GetParError(0));
    fitL0_L0_tight_topo_cuts_Delta_phi[1]->SetParError(1, fit_2_L0_L0_US_ThetaStar_2->GetParError(1));
    fitL0_L0_tight_topo_cuts_Delta_phi[1]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0_L0_tight_pT_cuts_Delta_phi[1]->SetParameters(fit_2_L0_L0_US_ThetaStar_2->GetParameter(0), fit_2_L0_L0_US_ThetaStar_2->GetParameter(1));
    fitL0_L0_tight_pT_cuts_Delta_phi[1]->SetParError(0, fit_2_L0_L0_US_ThetaStar_2->GetParError(0));
    fitL0_L0_tight_pT_cuts_Delta_phi[1]->SetParError(1, fit_2_L0_L0_US_ThetaStar_2->GetParError(1));
    fitL0_L0_tight_pT_cuts_Delta_phi[1]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0_L0_2 = SysErrSlope_delta_phi_more_hist[0]->GetBinContent(2);
  float SysErrSlope_L0_L0_2 = fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(2))/fabs(P_2_L0_L0_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(2))/fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(2));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(2));

  //----------------------------

  //background subtraction
  float P_2_L0_L0_from_fits = P_2_L0_L0 - nLL_2_back/nLL_2*P_L0_L0_back;
  float P_2_L0_L0_from_fits_err = sqrt( P_2_L0_L0_err*P_2_L0_L0_err + nLL_2_back/nLL_2*nLL_2_back/nLL_2*P_2_L0_L0_back_err*P_2_L0_L0_back_err );

  //statistical error correction for systematic error
  float SysErrBackground_L0_L0_corr_2 = sqrt( fabs( P_2_L0_L0_err_2*P_2_L0_L0_err_2 - P_2_L0_L0_from_fits_err*P_2_L0_L0_from_fits_err ) );

  float SysErrBackground_L0_L0_work_2 = ( fabs( P_2_L0_L0_2 - P_2_L0_L0_from_fits) - SysErrBackground_L0_L0_corr_2 )/fabs(P_2_L0_L0_2);

  float SysErrBackground_L0_L0_2 = 0;

  if( SysErrBackground_L0_L0_work_2 > 0 ) SysErrBackground_L0_L0_2 = SysErrBackground_L0_L0_work_2; //store sys. err. only if it is larger than statistical fluctuations

  SysErr_sum_background += SysErrBackground_L0_L0_2*fabs(P_2_L0_L0_2)/SysErrBackground_L0_L0_corr_2;
  SysErr_sum_of_w_background += 1./SysErrBackground_L0_L0_corr_2;

  //----------------------------

  //cuts variation
  float SysErr_tight_cuts_L0_L0_2 = 0;

  float SysErr_tight_topo_cuts_L0_L0_2 = 0;
  float SysErr_tight_pT_cuts_L0_L0_2 = 0;

  if(cut_type == 0)
  {
    float P_L0_L0_tight_topo_cuts = fitL0_L0_tight_topo_cuts_Delta_phi[1]->GetParameter(1)/(L0_alpha*L0_alpha);
    float P_L0_L0_tight_topo_cuts_err = fitL0_L0_tight_topo_cuts_Delta_phi[1]->GetParError(1)/(L0_alpha*L0_alpha);

    //statistical error correction for systematic error
    float SysErr_tight_topo_cuts_L0_L0_corr = sqrt( fabs( P_L0_L0_err_2*P_L0_L0_err_2 - P_L0_L0_tight_topo_cuts_err*P_L0_L0_tight_topo_cuts_err ) );

    float SysErr_tight_topo_cuts_L0_L0_work = ( fabs( P_2_L0_L0_2 - P_L0_L0_tight_topo_cuts) - SysErr_tight_topo_cuts_L0_L0_corr )/fabs(P_2_L0_L0_2);

    SysErr_tight_topo_cuts_L0_L0_2 = 0;

    if( SysErr_tight_topo_cuts_L0_L0_work > 0 ) SysErr_tight_topo_cuts_L0_L0_2 = SysErr_tight_topo_cuts_L0_L0_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_topo_cuts += SysErr_tight_topo_cuts_L0_L0_2*fabs(P_2_L0_L0_2)/SysErr_tight_topo_cuts_L0_L0_corr;
    SysErr_sum_of_w_topo_cuts += 1./SysErr_tight_topo_cuts_L0_L0_corr;


    float P_L0_L0_tight_pT_cuts = fitL0_L0_tight_pT_cuts_Delta_phi[1]->GetParameter(1)/(L0_alpha*L0_alpha);
    float P_L0_L0_tight_pT_cuts_err = fitL0_L0_tight_pT_cuts_Delta_phi[1]->GetParError(1)/(L0_alpha*L0_alpha);

    cout<<"P_L0_L0_tight_pT_cuts "<<P_L0_L0_tight_pT_cuts<<endl;
    cout<<"P_2_L0_L0_2 "<<P_2_L0_L0_2<<endl;

    //statistical error correction for systematic error
    float SysErr_tight_pT_cuts_L0_L0_corr = sqrt( fabs( P_L0_L0_err_2*P_L0_L0_err_2 - P_L0_L0_tight_pT_cuts_err*P_L0_L0_tight_pT_cuts_err ) );

    float SysErr_tight_pT_cuts_L0_L0_work = ( fabs( P_2_L0_L0_2 - P_L0_L0_tight_pT_cuts) - SysErr_tight_pT_cuts_L0_L0_corr )/fabs(P_2_L0_L0_2);

    SysErr_tight_pT_cuts_L0_L0_2 = 0;

    if( SysErr_tight_pT_cuts_L0_L0_work > 0 ) SysErr_tight_pT_cuts_L0_L0_2 = SysErr_tight_pT_cuts_L0_L0_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_pT_cut += SysErr_tight_pT_cuts_L0_L0_2*fabs(P_2_L0_L0_2)/SysErr_tight_pT_cuts_L0_L0_corr;
    SysErr_sum_of_w_pT_cut += 1./SysErr_tight_pT_cuts_L0_L0_corr;


    SysErr_tight_cuts_L0_L0_2 = sqrt(SysErr_tight_topo_cuts_L0_L0_2*SysErr_tight_topo_cuts_L0_L0_2 + SysErr_tight_pT_cuts_L0_L0_2*SysErr_tight_pT_cuts_L0_L0_2);
    //SysErr_tight_cuts_L0_L0_2 = SysErr_tight_topo_cuts_L0_L0;
    //SysErr_tight_cuts_L0_L0_2 = SysErr_tight_pT_cuts_L0_L0;
  }

  //total
  //float SysErrTot_L0_L0 = sqrt( sysErr_alpha_L0_L0*sysErr_alpha_L0_L0 + SysErrSlope_L0_L0*SysErrSlope_L0_L0 + SysErrBackground_L0_L0*SysErrBackground_L0_L0  );

  float SysErrTot_L0_L0_2 = sqrt( sysErr_alpha_L0_L0*sysErr_alpha_L0_L0 + SysErrSlope_L0_L0_2*SysErrSlope_L0_L0_2 + SysErrBackground_L0_L0_2*SysErrBackground_L0_L0_2 + SysErr_tight_cuts_L0_L0_2*SysErr_tight_cuts_L0_L0_2 );
  //float SysErrTot_L0_L0_2 = sqrt( sysErr_alpha_L0_L0*sysErr_alpha_L0_L0 + SysErrSlope_L0_L0_2*SysErrSlope_L0_L0_2 + SysErrBackground_L0_L0_2*SysErrBackground_L0_L0_2 );
  ...
  L0_L0_cosThetaProdPlane_2_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0_L0_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 1));

  PolarizationGraph_delta_phi[1]->SetPoint(2, P_2_L0_L0_2, 2);
  PolarizationGraph_delta_phi[1]->SetPointError(2, fabs(P_2_L0_L0_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[1]->SetPoint(2, P_2_L0_L0_2, 2);
  PolarizationGraph_delta_phi_sys_err[1]->SetPointError(2, fabs(SysErrTot_L0_L0_2*P_2_L0_L0_2), 0.045);
  ...
  TH1D *L0bar_L0bar_cosThetaProdPlane_US_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LbarLbar_US", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  //ME here just for plotting, used loser
  TH1D *L0bar_L0bar_cosThetaProdPlane_ME_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LbarLbar_US_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0bar_L0bar_cosThetaProdPlane_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LbarLbar_LS_%i", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  TH1D *L0bar_L0bar_cosThetaProdPlane_ME_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LbarLbar_LS_ME", bin_min, bin_middle); // |Delta_phi| < pi/4
  ...
  L0bar_L0bar_cosThetaProdPlane_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 0));
  ...
  L0bar_L0bar_cosThetaProdPlane_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_delta_phi_new_%i.png", 0));

  //----------------------------------------------------------------------

  TCanvas *L0bar_L0bar_cosThetaProdPlane_can_2 = new TCanvas("L0bar_L0bar_cosThetaProdPlane_can_2", "L0bar_L0bar_cosThetaProdPlane_can_2", 1200, 1000);

  L0bar_L0bar_cosThetaProdPlane_can_2->cd();

  L0bar_L0bar_cosThetaProdPlane_US_hist->Add(L0bar_L0bar_cosThetaProdPlane_LS_hist, -1);
  L0bar_L0bar_cosThetaProdPlane_US_hist->SetMinimum(0);
  L0bar_L0bar_cosThetaProdPlane_US_hist->Write(Form("L0bar_L0bar_cosThetaProdPlane_delta_phi_%i", 0));
  L0bar_L0bar_cosThetaProdPlane_US_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0bar_L0bar = SysErrSlope_delta_phi_less_hist[0]->GetBinContent(3);
  float SysErrSlope_L0bar_L0bar = fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(3))/fabs(P_L0bar_L0bar_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinContent(3))/fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(3));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_less_hist[0]->GetBinError(3));
  ...
  if(cut_type == 0)
  {
    float P_L0bar_L0bar_tight_topo_cuts = fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
    float P_L0bar_L0bar_tight_topo_cuts_err = fitL0bar_L0bar_tight_topo_cuts_Delta_phi[0]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
    ...
    SysErr_tight_topo_cuts_L0bar_L0bar = 0;
    ...
    float P_L0bar_L0bar_tight_pT_cuts = fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
    float P_L0bar_L0bar_tight_pT_cuts_err = fitL0bar_L0bar_tight_pT_cuts_Delta_phi[0]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
    ...
    SysErr_tight_pT_cuts_L0bar_L0bar = 0;
  ...
  L0bar_L0bar_cosThetaProdPlane_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 0));


  PolarizationGraph_delta_phi[0]->SetPoint(3, P_L0bar_L0bar_2, 3);
  PolarizationGraph_delta_phi[0]->SetPointError(3, fabs(P_L0bar_L0bar_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[0]->SetPoint(3, P_L0bar_L0bar_2, 3);
  PolarizationGraph_delta_phi_sys_err[0]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar*P_L0bar_L0bar_2), 0.045);

  //____________________________________________________________________________________________________________________________________________________________________________________________________________


  TCanvas *L0bar_L0bar_cosThetaProdPlane_no_corr_2_can = new TCanvas("L0bar_L0bar_cosThetaProdPlane_no_corr_2_can", "L0bar_L0bar_cosThetaProdPlane_no_corr_2_can", 1200, 1000);

  L0bar_L0bar_cosThetaProdPlane_no_corr_2_can->cd();

  TH1D *L0bar_L0bar_cosThetaProdPlane_US_2_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( "proj_LbarLbar_US_2", bin_middle+1, bin_max);
  ...
  //ME here just for plotting, used loser
  TH1D *L0bar_L0bar_cosThetaProdPlane_ME_2_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( "proj_LbarLbar_US_ME_2", bin_middle+1, bin_max);
  ...
  TH1D *L0bar_L0bar_cosThetaProdPlane_LS_2_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( "proj_LbarLbar_LS_2", bin_middle+1, bin_max);
  ...
  TH1D *L0bar_L0bar_cosThetaProdPlane_ME_LS_2_hist = L0bar_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( "proj_LbarLbar_LS_ME_2", bin_middle+1, bin_max);
  ...
  L0bar_L0bar_cosThetaProdPlane_no_corr_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", 1));
  ...
  L0bar_L0bar_cosThetaProdPlane_2_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_delta_phi_new_%i.png", 1));

  //----------------------------------------------------------------------

  TCanvas *L0bar_L0bar_cosThetaProdPlane_2_can_2 = new TCanvas("L0bar_L0bar_cosThetaProdPlane_2_can_2", "L0bar_L0bar_cosThetaProdPlane_2_can_2", 1200, 1000);
  ...
  L0bar_L0bar_cosThetaProdPlane_US_2_hist->SetMinimum(0);
  L0bar_L0bar_cosThetaProdPlane_US_2_hist->Write(Form("L0bar_L0bar_cosThetaProdPlane_delta_phi_%i", 1));
  L0bar_L0bar_cosThetaProdPlane_US_2_hist->Draw("p e");
  ...
  if(cut_type == 1)
  {
    ...
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->SetParameters(fit_2_L0bar_L0bar_US_ThetaStar_2->GetParameter(0), fit_2_L0bar_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->SetParError(0, fit_2_L0bar_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->SetParError(1, fit_2_L0bar_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->Write();
  }
  ...
  if(cut_type == 2)
  {
    ...
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->SetParameters(fit_2_L0bar_L0bar_US_ThetaStar_2->GetParameter(0), fit_2_L0bar_L0bar_US_ThetaStar_2->GetParameter(1));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->SetParError(0, fit_2_L0bar_L0bar_US_ThetaStar_2->GetParError(0));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->SetParError(1, fit_2_L0bar_L0bar_US_ThetaStar_2->GetParError(1));
    fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->Write();
  }
  ...
  //slope
  //float SysErrSlope_L0bar_L0bar_2 = SysErrSlope_delta_phi_more_hist[0]->GetBinContent(3);
  float SysErrSlope_L0bar_L0bar_2 = fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(3))/fabs(P_2_L0bar_L0bar_2);

  SysErr_sum_ME += fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinContent(3))/fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(3));
  SysErr_sum_of_w_ME += 1./fabs(ResidualPolarization_delta_phi_more_hist[0]->GetBinError(3));

  //----------------------------

  //background subtraction
  float P_2_L0bar_L0bar_from_fits = P_2_L0bar_L0bar - nLbarLbar_2_back/nLbarLbar_2*P_L0bar_L0bar_back;
  float P_2_L0bar_L0bar_from_fits_err = sqrt( P_2_L0bar_L0bar_err*P_2_L0bar_L0bar_err + nLbarLbar_2_back/nLbarLbar_2*nLbarLbar_2_back/nLbarLbar_2*P_2_L0bar_L0bar_back_err*P_2_L0bar_L0bar_back_err );

  //statistical error correction for systematic error
  float SysErrBackground_L0bar_L0bar_corr_2 = sqrt( fabs( P_2_L0bar_L0bar_err_2*P_2_L0bar_L0bar_err_2 - P_2_L0bar_L0bar_from_fits_err*P_2_L0bar_L0bar_from_fits_err ) );

  float SysErrBackground_L0bar_L0bar_work_2 = ( fabs( P_2_L0bar_L0bar_2 - P_2_L0bar_L0bar_from_fits) - SysErrBackground_L0bar_L0bar_corr_2 )/fabs(P_2_L0bar_L0bar_2);

  float SysErrBackground_L0bar_L0bar_2 = 0;

  if( SysErrBackground_L0bar_L0bar_work_2 > 0 ) SysErrBackground_L0bar_L0bar_2 = SysErrBackground_L0bar_L0bar_work_2; //store sys. err. only if it is larger than statistical fluctuations

  SysErr_sum_background += SysErrBackground_L0bar_L0bar_2*fabs(P_2_L0bar_L0bar_2)/SysErrBackground_L0bar_L0bar_corr_2;
  SysErr_sum_of_w_background += 1./SysErrBackground_L0bar_L0bar_corr_2;

  //----------------------------

  //cuts variation
  float SysErr_tight_cuts_L0bar_L0bar_2 = 0;

  float SysErr_tight_topo_cuts_L0bar_L0bar_2 = 0;
  float SysErr_tight_pT_cuts_L0bar_L0bar_2 = 0;

  if(cut_type == 0)
  {
    float P_L0bar_L0bar_tight_topo_cuts = fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
    float P_L0bar_L0bar_tight_topo_cuts_err = fitL0bar_L0bar_tight_topo_cuts_Delta_phi[1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

    //statistical error correction for systematic error
    float SysErr_tight_topo_cuts_L0bar_L0bar_corr = sqrt( fabs( P_L0bar_L0bar_err_2*P_L0bar_L0bar_err_2 - P_L0bar_L0bar_tight_topo_cuts_err*P_L0bar_L0bar_tight_topo_cuts_err ) );

    float SysErr_tight_topo_cuts_L0bar_L0bar_work = ( fabs( P_2_L0bar_L0bar_2 - P_L0bar_L0bar_tight_topo_cuts) - SysErr_tight_topo_cuts_L0bar_L0bar_corr )/fabs(P_2_L0bar_L0bar_2);

    SysErr_tight_topo_cuts_L0bar_L0bar_2 = 0;

    if( SysErr_tight_topo_cuts_L0bar_L0bar_work > 0 ) SysErr_tight_topo_cuts_L0bar_L0bar_2 = SysErr_tight_topo_cuts_L0bar_L0bar_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_topo_cuts += SysErr_tight_topo_cuts_L0bar_L0bar_2*fabs(P_2_L0bar_L0bar_2)/SysErr_tight_topo_cuts_L0bar_L0bar_corr;
    SysErr_sum_of_w_topo_cuts += 1./SysErr_tight_topo_cuts_L0bar_L0bar_corr;


    float P_L0bar_L0bar_tight_pT_cuts = fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
    float P_L0bar_L0bar_tight_pT_cuts_err = fitL0bar_L0bar_tight_pT_cuts_Delta_phi[1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);

    //statistical error correction for systematic error
    float SysErr_tight_pT_cuts_L0bar_L0bar_corr = sqrt( fabs( P_L0bar_L0bar_err_2*P_L0bar_L0bar_err_2 - P_L0bar_L0bar_tight_pT_cuts_err*P_L0bar_L0bar_tight_pT_cuts_err ) );

    float SysErr_tight_pT_cuts_L0bar_L0bar_work = ( fabs( P_2_L0bar_L0bar_2 - P_L0bar_L0bar_tight_pT_cuts) - SysErr_tight_pT_cuts_L0bar_L0bar_corr )/fabs(P_2_L0bar_L0bar_2);

    SysErr_tight_pT_cuts_L0bar_L0bar_2 = 0;

    if( SysErr_tight_pT_cuts_L0bar_L0bar_work > 0 ) SysErr_tight_pT_cuts_L0bar_L0bar_2 = SysErr_tight_pT_cuts_L0bar_L0bar_work; //store sys. err. only if it is larger than statistical fluctuations

    SysErr_sum_pT_cut += SysErr_tight_pT_cuts_L0bar_L0bar_2*fabs(P_2_L0bar_L0bar_2)/SysErr_tight_pT_cuts_L0bar_L0bar_corr;
    SysErr_sum_of_w_pT_cut += 1./SysErr_tight_pT_cuts_L0bar_L0bar_corr;


    SysErr_tight_cuts_L0bar_L0bar_2 = sqrt(SysErr_tight_topo_cuts_L0bar_L0bar_2*SysErr_tight_topo_cuts_L0bar_L0bar_2 + SysErr_tight_pT_cuts_L0bar_L0bar_2*SysErr_tight_pT_cuts_L0bar_L0bar_2);
    //SysErr_tight_cuts_L0bar_L0bar = SysErr_tight_topo_cuts_L0bar_L0bar;
    //SysErr_tight_cuts_L0bar_L0bar = SysErr_tight_pT_cuts_L0bar_L0bar;
  }
  ...
  //total
  //float SysErrTot_L0bar_L0bar = sqrt( sysErr_alpha_L0bar_L0bar*sysErr_alpha_L0bar_L0bar + SysErrSlope_L0bar_L0bar*SysErrSlope_L0bar_L0bar + SysErrBackground_L0bar_L0bar*SysErrBackground_L0bar_L0bar  );
  float SysErrTot_L0bar_L0bar_2 = sqrt( sysErr_alpha_L0bar_L0bar*sysErr_alpha_L0bar_L0bar + SysErrSlope_L0bar_L0bar_2*SysErrSlope_L0bar_L0bar_2 + SysErrBackground_L0bar_L0bar_2*SysErrBackground_L0bar_L0bar_2 + SysErr_tight_cuts_L0bar_L0bar_2*SysErr_tight_cuts_L0bar_L0bar_2 );
  ...
  L0bar_L0bar_cosThetaProdPlane_2_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi_new/L0bar_L0bar_cosThetaProdPlane_subtract_delta_phi_new_%i.png", 1));


  PolarizationGraph_delta_phi[1]->SetPoint(3, P_2_L0bar_L0bar_2, 3);
  PolarizationGraph_delta_phi[1]->SetPointError(3, fabs(P_2_L0bar_L0bar_err_2), 0);

  PolarizationGraph_delta_phi_sys_err[1]->SetPoint(3, P_2_L0bar_L0bar_2, 3);
  PolarizationGraph_delta_phi_sys_err[1]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar_2*P_2_L0bar_L0bar_2), 0.045);
  ...
  cout<<"P LLbar = "<<P_2_L0_L0bar_2<<" +- "<<P_2_L0_L0bar_err_2<<" +- "<<SysErrTot_L0_L0bar_2*P_2_L0_L0bar_2<<endl;
  cout<<"P LL = "<<P_2_L0_L0_2<<" +- "<<P_2_L0_L0_err_2<<" +- "<<SysErrTot_L0_L0_2*P_2_L0_L0_2<<endl;
  cout<<"P LbarLbar = "<<P_2_L0bar_L0bar_2<<" +- "<<P_2_L0bar_L0bar_err_2<<" +- "<<SysErrTot_L0bar_L0bar_2*P_2_L0bar_L0bar_2<<endl;
  cout<<endl;

  cout<<"Systematic uncetainties by source:"<<endl;
  cout<<"pair | s_topo | s_pT | s_bckg | s_ME | s_alpha"<<endl;
  cout<<"LLbar: "<<P_2_L0_L0bar_2*SysErr_tight_topo_cuts_L0_L0bar_2<<" | "<<P_2_L0_L0bar_2*SysErr_tight_pT_cuts_L0_L0bar_2<<" | "<<P_2_L0_L0bar_2*SysErrBackground_L0_L0bar_2<<" | "<<P_2_L0_L0bar_2*SysErrSlope_L0_L0bar_2<<" | "<<P_2_L0_L0bar_2*sysErr_alpha_L0_L0bar<<endl;
  cout<<"LL: "<<P_2_L0_L0_2*SysErr_tight_topo_cuts_L0_L0_2<<" | "<<P_2_L0_L0_2*SysErr_tight_pT_cuts_L0_L0_2<<" | "<<P_2_L0_L0_2*SysErrBackground_L0_L0_2<<" | "<<P_2_L0_L0_2*SysErrSlope_L0_L0_2<<" | "<<P_2_L0_L0_2*sysErr_alpha_L0_L0<<endl;
  cout<<"LbarLbar: "<<P_2_L0bar_L0bar_2*SysErr_tight_topo_cuts_L0bar_L0bar_2<<" | "<<P_2_L0bar_L0bar_2*SysErr_tight_pT_cuts_L0bar_L0bar_2<<" | "<<P_2_L0bar_L0bar_2*SysErrBackground_L0bar_L0bar_2<<" | "<<P_2_L0bar_L0bar_2*SysErrSlope_L0bar_L0bar_2<<" | "<<P_2_L0bar_L0bar_2*sysErr_alpha_L0bar_L0bar<<endl;
  cout<<endl;
  ...
  for(unsigned int bin = 1; bin < 3; bin++)
  {
    ...
    //PolarizationGraph_delta_phi_sys_err_average[bin-1]->Write(Form("PolarizationGraph_delta_y_sys_err_average_%i", delta_eta_bin-1));
