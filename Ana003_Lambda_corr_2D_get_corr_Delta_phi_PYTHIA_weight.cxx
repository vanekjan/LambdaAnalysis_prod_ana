...
bool Ana003_Lambda_corr_2D_get_corr_Delta_phi_PYTHIA_weight(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  //Delta phi reweight file (file with PYTHIA distributions)

  TFile *PYTHIA_file = new TFile("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/Weight/output_Lambda_pp_200_MB_1B_events_hists_100_SE_in_ME.root", "read");

  TH2F *L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_cuts_hist = (TH2F*)PYTHIA_file->Get("L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_cuts_hist");
  ...
  for( unsigned int delta_phi_bin = 0; delta_phi_bin < 3; delta_phi_bin++)
  {
    ...
    TCanvas *L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_can = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_can%i", delta_phi_bin), Form("L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_can%i", delta_phi_bin), 1200, 1000);

    L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_can->cd();


    TH1D* L0_L0bar_cosThetaProdPlane_US_hist_clone = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( Form("proj_US_clone_%i", delta_phi_bin), 1, 5*delta_phi_bin+5);
    //TH1D* L0_L0bar_cosThetaProdPlane_US_hist_clone = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( Form("proj_US_clone_%i", delta_phi_bin), delta_phi_bin+1, delta_phi_bin+1);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->GetXaxis()->SetTitle("cos(#theta*)");
    L0_L0bar_cosThetaProdPlane_US_hist_clone->GetXaxis()->CenterTitle();
    //L0_L0bar_cosThetaProdPlane_US_hist_clone->GetXaxis()->SetTextSizePixels(30);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->GetYaxis()->SetTitle("d#it{N}/d cos(#theta*)");
    L0_L0bar_cosThetaProdPlane_US_hist_clone->GetYaxis()->CenterTitle();
    //L0_L0bar_cosThetaProdPlane_US_hist_clone->GetYaxis()->SetTextSizePixels(30);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->GetYaxis()->SetMaxDigits(3);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->SetMarkerSize(1.5);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->SetMarkerStyle(20);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->SetMarkerColor(kRed);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->SetLineColor(kRed);
    double nLLbar_clone = L0_L0bar_cosThetaProdPlane_US_hist_clone->Integral();
    L0_L0bar_cosThetaProdPlane_US_hist_clone->Sumw2();
    //L0_L0bar_cosThetaProdPlane_US_hist_clone->Divide(L0_L0bar_cosThetaProdPlane_eff);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->Scale(1./L0_L0bar_cosThetaProdPlane_US_hist_clone->GetXaxis()->GetBinWidth(1));
    //L0_L0bar_cosThetaProdPlane_US_hist_clone_clone->Add(L0_L0bar_cosThetaProdPlane_LS_hist, -1);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->SetMinimum(0);
    L0_L0bar_cosThetaProdPlane_US_hist_clone->Draw("p e");

    //ME here just for plotting, used loser
    TH1D *L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_cuts_hist->ProjectionX(Form("proj_SE_%i", delta_phi_bin), 1, 5*delta_phi_bin+5);
    //TH1D *L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_cuts_hist->ProjectionX(Form("proj_SE_%i", delta_phi_bin), delta_phi_bin+1, delta_phi_bin+1);
    //TH1D *L0_L0bar_cosThetaProdPlane_ME_hist = L0_L0bar_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", delta_phi_bin), 1, delta_phi_bin+1);

    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->SetMarkerSize(1.5);
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->SetMarkerStyle(24);
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->SetMarkerColor(1);
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->SetLineColor(1);
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Sumw2();
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Scale(nLLbar_clone/L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Integral()); //scale ME to US
    //L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Scale((nLLbar-nLLbar_back)/L0_L0bar_cosThetaProdPlane_ME_hist->Integral()); //scale ME to US
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Scale(1./L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->GetXaxis()->GetBinWidth(1)); //US is scaled by bin width, ME needs to be scaled as well
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->SetMinimum(0);
    L0_L0bar_cosThetaProdPlane_less_delta_phi_cuts->Draw("p e same");

    L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_phi/L0_L0bar_cosThetaProdPlane_no_corr_PYTHIA_less_delta_phi_%i.png", delta_phi_bin));
