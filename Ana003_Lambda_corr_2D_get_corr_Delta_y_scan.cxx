...
bool Ana003_Lambda_corr_2D_get_corr_Delta_y_scan(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  TH1F *SysErrSlope_Delta_y_hist[2];

  for( unsigned int Delta_y_bin = 0; Delta_y_bin < 2; Delta_y_bin++ )
  {
    //SysErrSlope_Delta_y_hist[Delta_y_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_Delta_y_hist_%i", Delta_y_bin));
    SysErrSlope_Delta_y_hist[Delta_y_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_delta_eta_delta_phi_hist_%i", Delta_y_bin));
  }
  ...
  {
    if( cut_type == 1 ) SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_topo_cuts_Delta_y_scan_work.root", year), "recreate");
    if( cut_type == 2 ) SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_tight_pT_cuts_Delta_y_scan_work.root", year), "recreate");
  }
  ...
  for( unsigned int Delta_y_bin = 0; Delta_y_bin < 2; Delta_y_bin++)
  {
    if(cut_type == 0 )
    {
      ...
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_%i", Delta_y_bin));
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0_L0_tight_topo_cuts_Delta_y_%i", Delta_y_bin));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_%i", Delta_y_bin));

      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_%i", Delta_y_bin));
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0_L0_tight_pT_cuts_Delta_y_%i", Delta_y_bin));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin] = (TF1*)SysErrCutsPt->Get(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_%i", Delta_y_bin));


    }
    else
    {
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0_L0bar_tight_topo_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0_L0_tight_topo_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0bar_L0bar_tight_topo_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);


      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0_L0bar_tight_pT_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);

      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0_L0_tight_pT_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);

      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin] = new TF1(Form("fitL0bar_L0bar_tight_pT_cuts_Delta_y_%i", Delta_y_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin]->SetParameters(100, 0.5);
    }
  ...
  //data histograms
  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist");

  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist");

  //--------------------------------------------------------

  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_hist");

  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_hist");

  //--------------------------------------------------------

  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist");

  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist");

  //--------------------------------------------------------

  //mixed event
  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist");
  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist");

  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist");
  TH2F *L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist");

  //--------------------------------------------------------

  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_ME_hist");
  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist");

  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist");
  TH2F *L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist");

  //--------------------------------------------------------

  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist");
  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist");

  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_alt_hist");
  TH2F *L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist = (TH2F*)LLbarOutFile->Get("L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_alt_hist");
  ...
  TGraphErrors *PolarizationGraph_Delta_y[2];
  TGraphErrors *PolarizationGraph_Delta_y_sys_err[2];


  TCanvas *PolarizationGraph_Delta_y_can = new TCanvas("PolarizationGraph_Delta_y_can", "PolarizationGraph_Delta_y_can", 2000, 1200);
  PolarizationGraph_Delta_y_can->Divide(2,1);
  ...
  int bin_projection = 5; //bin 5 - |Delta y| = 0.5

  for( unsigned int Delta_y_bin = 1; Delta_y_bin < 3; Delta_y_bin++)
  {
    //create polarization graphs, defined earlier

    PolarizationGraph_Delta_y[Delta_y_bin-1] = new TGraphErrors(3);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1] = new TGraphErrors(3);
    ...
    {
      bin_min = 1;
      bin_max = bin_projection;

      bin_edge = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist->GetYaxis()->GetBinUpEdge(bin_max);
    }
    if(Delta_y_bin == 2)
    {
      bin_min = bin_projection+1;
      bin_max = 20;

      bin_edge = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist->GetYaxis()->GetBinLowEdge(bin_min);
    }
    ...
    TCanvas *L0_L0bar_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), Form("L0_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), 1200, 1000);

    L0_L0bar_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0_L0bar_cosThetaProdPlane_eta_US_hist = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist->ProjectionX( Form("proj_US_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_ME_hist = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_LS_hist = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist->ProjectionX( Form("proj_LS_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0bar_cosThetaProdPlane_eta_ME_LS_hist = L0_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    L0_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0bar_cosThetaProdPlane_eta_no_corr_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0_L0bar_cosThetaProdPlane_eta_can = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_can_%i", Delta_y_bin), Form("L0_L0bar_cosThetaProdPlane_eta_can_%i", Delta_y_bin), 1200, 1000);
    ...
    L0_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0bar_cosThetaProdPlane_eta_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------

    TCanvas *L0_L0bar_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0_L0bar_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), Form("L0_L0bar_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), 1200, 1000);
    ...
    L0_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0bar_cosThetaProdPlane_Delta_y_%i", Delta_y_bin-1));
    L0_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0_L0bar_US_ThetaStar_2->GetParameter(0), fitL0_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
...
cout<<"hovno"<<endl;
    ...
    //slope
    float SysErrSlope_L0_L0bar = SysErrSlope_Delta_y_hist[Delta_y_bin-1]->GetBinContent(1);
    ...
    if(cut_type == 0)
    {
      float P_L0_L0bar_tight_topo_cuts = fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_topo_cuts_err = fitL0_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
      ...
      float P_L0_L0bar_tight_pT_cuts = fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0_alpha*L0bar_alpha);
      float P_L0_L0bar_tight_pT_cuts_err = fitL0_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0_alpha*L0bar_alpha);
    ...
    L0_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0bar_cosThetaProdPlane_eta_subtract_less_Delta_y_%i.png", Delta_y_bin));

    //-----------------------


    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPoint(1, P_L0_L0bar_2, 1);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPointError(1, fabs(P_L0_L0bar_err_2), 0);


    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPoint(1, P_L0_L0bar_2, 1);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPointError(1, fabs(SysErrTot_L0_L0bar*P_L0_L0bar_2), 0.045);

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    TCanvas *L0_L0_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), Form("L0_L0_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), 1200, 1000);

    L0_L0_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0_L0_cosThetaProdPlane_eta_US_hist = L0_L0_cos_theta_star_vs_delta_eta_scan_US_hist->ProjectionX( Form("proj_US_%i", Delta_y_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_hist = L0_L0_cos_theta_star_vs_delta_eta_scan_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_LS_hist = L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_hist->ProjectionX( Form("proj_LS_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0_L0_cosThetaProdPlane_eta_ME_LS_hist = L0_L0_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    L0_L0_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0_cosThetaProdPlane_eta_no_corr_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0_L0_cosThetaProdPlane_eta_can = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_can_%i", Delta_y_bin), Form("L0_L0_cosThetaProdPlane_eta_can_%i", Delta_y_bin), 1200, 1000);
    ...
    L0_L0_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0_cosThetaProdPlane_eta_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------

    TCanvas *L0_L0_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0_L0_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), Form("L0_L0_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), 1200, 1000);

    L0_L0_cosThetaProdPlane_eta_can_2->cd();

    L0_L0_cosThetaProdPlane_eta_US_hist->Add(L0_L0_cosThetaProdPlane_eta_LS_hist, -1);
    L0_L0_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0_L0_cosThetaProdPlane_eta_US_hist->Write(Form("L0_L0_cosThetaProdPlane_Delta_y_%i", Delta_y_bin-1));
    L0_L0_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0_L0_US_ThetaStar_2->GetParameter(0), fitL0_L0_US_ThetaStar_2->GetParameter(1));
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0_L0_US_ThetaStar_2->GetParError(0));
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0_L0_US_ThetaStar_2->GetParError(1));
      fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
    ...
    L0_L0_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0_L0_cosThetaProdPlane_eta_subtract_less_Delta_y_%i.png", Delta_y_bin));

    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPoint(2, P_L0_L0_2, 2);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPointError(2, fabs(P_L0_L0_err_2), 0);

    //calculate total systematic uncertainty for L-Lbar

    //slope
    float SysErrSlope_L0_L0 = SysErrSlope_Delta_y_hist[Delta_y_bin-1]->GetBinContent(2);
    ...
    if(cut_type == 0)
    {
      float P_L0_L0_tight_topo_cuts = fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_topo_cuts_err = fitL0_L0_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
      ...
      float P_L0_L0_tight_pT_cuts = fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_L0_L0_tight_pT_cuts_err = fitL0_L0_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
    ...
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPoint(2, P_L0_L0_2, 2);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPointError(2, fabs(SysErrTot_L0_L0*P_L0_L0_2), 0.045);

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can_%i", Delta_y_bin), 1200, 1000);

    L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can->cd();

    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_US_hist = L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_hist->ProjectionX( Form("proj_US_%i", Delta_y_bin), bin_min, bin_max);
    ...
    //ME here just for plotting, used loser
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_hist = L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_ME_hist->ProjectionX( Form("proj_US_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_hist->ProjectionX( Form("proj_LS_%i", Delta_y_bin), bin_min, bin_max);
    ...
    TH1D *L0bar_L0bar_cosThetaProdPlane_eta_ME_LS_hist = L0bar_L0bar_cos_theta_star_vs_delta_eta_scan_US_LS_ME_hist->ProjectionX( Form("proj_LS_ME_%i", Delta_y_bin), bin_min, bin_max);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0bar_L0bar_cosThetaProdPlane_eta_no_corr_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_can = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_can_%i", Delta_y_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_can_%i", Delta_y_bin), 1200, 1000);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0bar_L0bar_cosThetaProdPlane_eta_less_Delta_y_%i.png", Delta_y_bin));

    //----------------------------------------------------------------------

    TCanvas *L0bar_L0bar_cosThetaProdPlane_eta_can_2 = new TCanvas(Form("L0bar_L0bar_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), Form("L0bar_L0bar_cosThetaProdPlane_eta_can_2_%i", Delta_y_bin), 1200, 1000);
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->SetMinimum(0);
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Write(Form("L0bar_L0bar_cosThetaProdPlane_Delta_y_%i", Delta_y_bin-1));
    L0bar_L0bar_cosThetaProdPlane_eta_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParameters(fitL0bar_L0bar_US_ThetaStar_2->GetParameter(0), fitL0bar_L0bar_US_ThetaStar_2->GetParameter(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(0, fitL0bar_L0bar_US_ThetaStar_2->GetParError(0));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->SetParError(1, fitL0bar_L0bar_US_ThetaStar_2->GetParError(1));
      fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->Write();
    }
    ...
    L0bar_L0bar_cosThetaProdPlane_eta_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_correlations_delta_eta_scan/L0bar_L0bar_cosThetaProdPlane_eta_subtract_less_Delta_y_%i.png", Delta_y_bin));

    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPoint(3, P_L0bar_L0bar_2, 3);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetPointError(3, fabs(P_L0bar_L0bar_err_2), 0);

    //calculate total systematic uncertainty for L-Lbar

    //slope
    float SysErrSlope_L0bar_L0bar = SysErrSlope_Delta_y_hist[Delta_y_bin-1]->GetBinContent(3);
    ...
    if(cut_type == 0)
    {
      float P_L0bar_L0bar_tight_topo_cuts = fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_topo_cuts_err = fitL0bar_L0bar_tight_topo_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
      ...
      float P_L0bar_L0bar_tight_pT_cuts = fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParameter(1)/(L0bar_alpha*L0bar_alpha);
      float P_L0bar_L0bar_tight_pT_cuts_err = fitL0bar_L0bar_tight_pT_cuts_Delta_y[Delta_y_bin-1]->GetParError(1)/(L0bar_alpha*L0bar_alpha);
    ...
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPoint(3, P_L0bar_L0bar_2, 3);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetPointError(3, fabs(SysErrTot_L0bar_L0bar*P_L0bar_L0bar_2), 0.045);
    ...
    PolarizationGraph_Delta_y[Delta_y_bin-1]->Write(Form("PolarizationGraph_Delta_y_%i", Delta_y_bin-1));
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->Write(Form("PolarizationGraph_Delta_y_sys_err_%i", Delta_y_bin-1));

    //____________________________________________________________________________________________________________________________________________________________________________________________________________

    //plot polarization graphs in bins
    PolarizationGraph_Delta_y_can->cd(Delta_y_bin);
    ...
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetMarkerStyle(20);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetMarkerColor(kRed);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Delta_y[Delta_y_bin-1]->Draw("p e same");

    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetMarkerSize(2);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetFillColorAlpha(kRed, 0.25);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->SetLineColor(kRed);
    PolarizationGraph_Delta_y_sys_err[Delta_y_bin-1]->Draw("2 same");

    ZeroLine_eta->Draw("same");

    bin_text[Delta_y_bin-1] = new TPaveText(0.12, 0.85, 0.49, 0.89, "NDC");
    bin_text[Delta_y_bin-1]->SetTextFont(42);
    if(Delta_y_bin == 1) bin_text[Delta_y_bin-1]->AddText(Form("|#Deltay| < %.1f", bin_edge));
    if(Delta_y_bin == 2) bin_text[Delta_y_bin-1]->AddText(Form("%.1f < |#Deltay| < 2", bin_edge));
    bin_text[Delta_y_bin-1]->SetFillColorAlpha(0, 0.01);
    bin_text[Delta_y_bin-1]->Draw("same");

    if(Delta_y_bin == 1 ) Polarization_text->Draw("same");

    //----------------------------------L pair stats---------------------------------
    cout<<endl;
    cout<<"Bin "<<Delta_y_bin<<endl;
    cout<<endl;
  ...
  PolarizationGraph_Delta_y_can->SaveAs("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/Lambda/2D_analysis/L_polarization/L_polarization_delta_eta_scan.png");
