...
bool Ana004_K0s_corr_2D_get_corr_Delta_phi_new(const int cut_type = 0, const int energy = 510, const int year = 2017)
{
  ...
  {
    SysErrSlope_delta_phi_hist[delta_eta_bin] = (TH1F*)SysErrSlopeFile->Get(Form("SysErrSlope_K0s_delta_phi_hist_%i", delta_eta_bin));
    ResidualPolarization_delta_phi_hist[delta_eta_bin] = (TH1F*)SysErrSlopeFile->Get(Form("ResidualPolarization_K0s_delta_phi_hist_%i", delta_eta_bin));
  }
  ...
  if(cut_type == 0 )
  {
    SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_topo_cuts_Delta_phi_work.root", year), "read");

    SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_pT_cuts_Delta_phi_work.root", year), "read");
  }
  else
  {
    if( cut_type == 1 ) SysErrCutsTopo = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_topo_cuts_Delta_phi_work.root", year), "recreate");
    if( cut_type == 2 ) SysErrCutsPt = new TFile(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/input/SysErr/%i/SysErr_K0s_tight_pT_cuts_Delta_phi_work.root", year), "recreate");
  }


  //tight cuts
  //topological cuts
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_phi_US[2];
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[2];
  TF1 *fitK0s_K0s_tight_topo_cuts_Delta_phi[2];


  //daughter pT cuts
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_phi_US[2];
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[2];
  TF1 *fitK0s_K0s_tight_pT_cuts_Delta_phi[2];
  ...
  for( unsigned int delta_eta_bin = 0; delta_eta_bin < 2; delta_eta_bin++)
  {
    if(cut_type == 0 )
    {
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_US_%i", delta_eta_bin));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS_%i", delta_eta_bin));
      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin] = (TF1*)SysErrCutsTopo->Get(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_%i", delta_eta_bin));


      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_US_%i", delta_eta_bin));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS_%i", delta_eta_bin));
      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin] = (TF1*)SysErrCutsPt->Get(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_%i", delta_eta_bin));
    }
    else
    {
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_topo_cuts_Delta_phi_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin]->SetParameters(100, 0.5);

      //-----------------------------------------------------------------------------------------

      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_US_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin]->SetParameters(100, 0.5);

      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin] = new TF1(Form("fitK0s_K0s_tight_pT_cuts_Delta_phi_%i", delta_eta_bin), "[0]*(1 + [1]*x)", -1, 1);
      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin]->SetParameters(100, 0.5);
    }
  ...
  for( unsigned int delta_eta_bin = 1; delta_eta_bin < 3; delta_eta_bin++)
  {
    ...
    TCanvas *K0s_K0s_cosThetaProdPlane_no_corr_can = new TCanvas(Form("K0s_K0s_cosThetaProdPlane_no_corr_can_%i", delta_eta_bin), Form("K0s_K0s_cosThetaProdPlane_no_corr_can_%i", delta_eta_bin), 1200, 1000);

    K0s_K0s_cosThetaProdPlane_no_corr_can->cd();

    TH1D *K0s_K0s_cosThetaProdPlane_US_hist = K0s_K0s_cos_theta_star_vs_delta_phi_for_corr_US_hist->ProjectionX( Form("proj_LL_US_%i", delta_eta_bin), bin_min_loop, bin_max_loop); // |Delta_phi| < pi/4
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_ME_hist = K0s_K0s_cos_theta_star_vs_delta_phi_for_corr_US_ME_hist->ProjectionX( Form("proj_LL_US_ME_%i", delta_eta_bin), bin_min_loop, bin_max_loop); // |Delta_phi| < pi/4
    ...
    K0s_K0s_cosThetaProdPlane_ME_hist->Scale(nK0sK0s/K0s_K0s_cosThetaProdPlane_ME_hist->Integral()); //scale ME to US
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_LS_hist = K0s_K0s_cos_theta_star_vs_delta_phi_for_corr_US_LS_hist->ProjectionX( Form("proj_LL_LS_%i", delta_eta_bin), bin_min_loop, bin_max_loop); // |Delta_phi| < pi/4
    ...
    TH1D *K0s_K0s_cosThetaProdPlane_ME_LS_hist = K0s_K0s_cos_theta_star_vs_delta_phi_for_corr_US_LS_ME_hist->ProjectionX( Form("proj_LL_LS_ME_%i", delta_eta_bin), bin_min_loop, bin_max_loop); // |Delta_phi| < pi/4
    ...
    K0s_K0s_cosThetaProdPlane_ME_LS_hist->Scale(nK0sK0s_back/K0s_K0s_cosThetaProdPlane_ME_LS_hist->Integral()); //scale ME_LS to background
    ...
    K0s_K0s_cosThetaProdPlane_no_corr_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_phi_new/K0s_K0s_cosThetaProdPlane_no_corr_delta_phi_new_%i.png", delta_eta_bin));

    //----------------------------------------------------------------------------------------------------

    TCanvas *K0s_K0s_cosThetaProdPlane_can = new TCanvas(Form("K0s_K0s_cosThetaProdPlane_can_%i", delta_eta_bin), Form("K0s_K0s_cosThetaProdPlane_can_%i", delta_eta_bin), 1200, 1000);
    ...
    K0s_K0s_cosThetaProdPlane_US_hist->Scale(nK0sK0s/K0s_K0s_cosThetaProdPlane_US_hist->Integral()); //scale back to raw US
    ...
    K0s_K0s_cosThetaProdPlane_LS_hist->Scale(nK0sK0s_back/K0s_K0s_cosThetaProdPlane_LS_hist->Integral()); //scale back to raw background
    ...
    K0s_K0s_cosThetaProdPlane_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_phi_new/K0s_K0s_cosThetaProdPlane_delta_phi_new_%i.png", delta_eta_bin));

    //----------------------------------------------------------------------

    TCanvas *K0s_K0s_cosThetaProdPlane_can_2 = new TCanvas(Form("K0s_K0s_cosThetaProdPlane_can_2_%i", delta_eta_bin), Form("K0s_K0s_cosThetaProdPlane_can_2_%i", delta_eta_bin), 1200, 1000);

    K0s_K0s_cosThetaProdPlane_can_2->cd();

    K0s_K0s_cosThetaProdPlane_US_hist->Add(K0s_K0s_cosThetaProdPlane_LS_hist, -1);
    K0s_K0s_cosThetaProdPlane_US_hist->SetMinimum(0);
    K0s_K0s_cosThetaProdPlane_US_hist->Write(Form("K0s_K0s_cosThetaProdPlane_delta_phi_%i", delta_eta_bin-1));
    K0s_K0s_cosThetaProdPlane_US_hist->Draw("p e");
    ...
    if(cut_type == 1)
    {
      ...
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar->GetParameter(0), fitK0s_K0s_US_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_LS_ThetaStar->GetParameter(0), fitK0s_K0s_US_LS_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_LS_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_LS_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar_2->GetParameter(0), fitK0s_K0s_US_ThetaStar_2->GetParameter(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar_2->GetParError(0));
      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar_2->GetParError(1));
      fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->Write();
    }
    ...
    if(cut_type == 2)
    {
      ...
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar->GetParameter(0), fitK0s_K0s_US_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_LS_ThetaStar->GetParameter(0), fitK0s_K0s_US_LS_ThetaStar->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_LS_ThetaStar->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_LS_ThetaStar->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->Write();

      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->SetParameters(fitK0s_K0s_US_ThetaStar_2->GetParameter(0), fitK0s_K0s_US_ThetaStar_2->GetParameter(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->SetParError(0, fitK0s_K0s_US_ThetaStar_2->GetParError(0));
      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->SetParError(1, fitK0s_K0s_US_ThetaStar_2->GetParError(1));
      fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->Write();
    }
    ...
    K0s_K0s_cosThetaProdPlane_can_2->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/STAR/Production/plots/K0s/2D_analysis/K0s_correlations_delta_phi_new/K0s_K0s_cosThetaProdPlane_subtract_delta_phi_new_%i.png", delta_eta_bin));
    ...
    //slope
    //float SysErrSlope_K0s_K0s = SysErrSlope_delta_phi_less_hist[delta_eta_bin-1]->GetBinContent(1);
    //float SysErrSlope_K0s_K0s = SysErrSlope_delta_eta_hist[delta_eta_bin-1]->GetBinContent(2);

    float SysErrSlope_K0s_K0s = fabs(ResidualPolarization_delta_phi_hist[delta_eta_bin-1]->GetBinContent(1))/fabs(P_K0s_K0s_2);
    ...
    if(cut_type == 0)
    {
      ...
      float P_K0s_K0s_tight_topo_cuts_from_fits = fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_from_fits_err = fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      cout<<"test"<<endl;

      float nK0sK0s_tight_topo_cuts_fit = fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_topo_cuts_fit_err = fitK0s_K0s_tight_topo_cuts_Delta_phi_US[delta_eta_bin-1]->GetParError(0);




      float P_K0s_K0s_tight_topo_cuts_from_fits_back = fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_from_fits_back_err = fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_topo_cuts_back_fit = fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_topo_cuts_back_fit_err = fitK0s_K0s_tight_topo_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_K0s_K0s_tight_topo_cuts = fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_topo_cuts_err = fitK0s_K0s_tight_topo_cuts_Delta_phi[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
      ...
      float P_K0s_K0s_tight_pT_cuts_from_fits = fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_from_fits_err = fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_pT_cuts_fit = fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_pT_cuts_fit_err = fitK0s_K0s_tight_pT_cuts_Delta_phi_US[delta_eta_bin-1]->GetParError(0);


      float P_K0s_K0s_tight_pT_cuts_from_fits_back = fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_from_fits_back_err = fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);

      float nK0sK0s_tight_pT_cuts_back_fit = fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParameter(0);
      float nK0sK0s_tight_pT_cuts_back_fit_err = fitK0s_K0s_tight_pT_cuts_Delta_phi_US_LS[delta_eta_bin-1]->GetParError(0);
      ...
      float P_K0s_K0s_tight_pT_cuts = fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->GetParameter(1)/(L0_alpha*L0_alpha);
      float P_K0s_K0s_tight_pT_cuts_err = fitK0s_K0s_tight_pT_cuts_Delta_phi[delta_eta_bin-1]->GetParError(1)/(L0_alpha*L0_alpha);
    ...
    //PolarizationGraph_delta_phi[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_2, 4);
    //PolarizationGraph_delta_phi[delta_eta_bin-1]->SetPointError(1, fabs(P_K0s_K0s_err_2), 0);

    PolarizationGraph_delta_phi[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_from_fits, 4);
    PolarizationGraph_delta_phi[delta_eta_bin-1]->SetPointError(1, fabs(P_K0s_K0s_from_fits_err), 0);


    //PolarizationGraph_delta_phi_sys_err[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_2, 4);
    //PolarizationGraph_delta_phi_sys_err[delta_eta_bin-1]->SetPointError(1, fabs(SysErrTot_K0s_K0s*P_K0s_K0s_2), 0.045);

    PolarizationGraph_delta_phi_sys_err[delta_eta_bin-1]->SetPoint(1, P_K0s_K0s_from_fits, 4);
    PolarizationGraph_delta_phi_sys_err[delta_eta_bin-1]->SetPointError(1, fabs(SysErrTot_K0s_K0s*P_K0s_K0s_from_fits), 0.045);
    ...
    PolarizationGraph_delta_phi[delta_eta_bin-1]->Write(Form("PolarizationGraph_delta_phi_%i", delta_eta_bin-1));
    PolarizationGraph_delta_phi_sys_err[delta_eta_bin-1]->Write(Form("PolarizationGraph_delta_phi_sys_err_%i", delta_eta_bin-1));
  ...
  {
    //float K0sK0s_SysErrTot_weights_work_relat = SysErrTot_weights_work/PolarizationGraph_delta_phi[bin-1]->GetPointX(1);
    float K0sK0s_SysErrTot_weights_work_relat = SysErrTot_weights_from_fits_work/PolarizationGraph_delta_phi[bin-1]->GetPointX(1);
    ...
    PolarizationGraph_delta_phi_sys_err_average[bin-1]->SetPoint(1, PolarizationGraph_delta_phi[bin-1]->GetPointX(1), 4);
    PolarizationGraph_delta_phi_sys_err_average[bin-1]->SetPointError(1, K0sK0s_SysErrTot_weights*PolarizationGraph_delta_phi[bin-1]->GetPointX(1), 0.045);

    PolarizationGraph_delta_phi_sys_err_average[bin-1]->Write(Form("PolarizationGraph_delta_y_sys_err_average_%i", bin-1));
    ...
    PolarizationGraph_delta_phi_sys_err_average[bin-1]->Write(Form("PolarizationGraph_delta_phi_sys_err_%i", bin-1));
